> [韩语版](https://www.atomai.click/kubernetes-docs/ko/)

# Kubernetes 和 Amazon EKS 培训内容
[![GitBook](https://img.shields.io/static/v1?message=Documented%20on%20GitBook&logo=gitbook&logoColor=ffffff&label=%20&labelColor=5c5c5c&color=3F89A1)](https://www.gitbook.com/preview?utm_source=gitbook_readme_badge&utm_medium=organic&utm_campaign=preview_documentation&utm_content=link)

本仓库是一份全面的云指南，涵盖 Linux 和容器基础、Kubernetes 和 Amazon EKS、网络、服务网格、存储、数据库、数据管道、AI/ML，以及安全与运维。除学习资料外，它还提供在真实 AWS 环境中测得的基准数据，以及按主题组织的测验和精选动手实验。

## 学习资料和测验

本培训内容为每个主题提供学习资料和测验。您可以通过测验检验并巩固所学内容。每个测验都采用隐藏答案的切换式设计，让您可以先尝试回答问题，再显示答案。

- [学习资料目录](#table-of-contents) - 按主题组织的学习资料
- [测验合集](./quizzes/README.md) - 按主题组织的测验
...
2. [容器背后的内核功能](./kernel/01-container-primitives.md) | [测验](./quizzes/kernel/01-container-primitives-quiz.md)
...
3. EKS 网络
   ...
   - [第 3 部分：性能优化、故障排除和高级用例](./eks/03-eks-networking-part3.md) | [测验](./quizzes/eks/03-eks-networking-part3-quiz.md)
4. EKS 存储
   ...
   - [第 3 部分：监控、故障排除、成本优化、安全](./eks/04-eks-storage-part3.md) | [测验](./quizzes/eks/04-eks-storage-part3-quiz.md)
...
### EKS 混合节点
1. [EKS 混合节点简介](./eks-hybrid-nodes/README.md)
...
11. [混合节点网关](./eks-hybrid-nodes/10-hybrid-nodes-gateway.md) | [测验](./quizzes/eks-hybrid-nodes/10-hybrid-nodes-gateway-quiz.md)
...
1. [从零开始学习 Linux 网络](./networking/beginner/README.md)
   ...
   - [4. DNS 和连通性](./networking/beginner/04-dns-connectivity.md) | [测验](./quizzes/networking/beginner/04-dns-connectivity-quiz.md)
...
2. [Kubernetes 网络概览](./networking/README.md) | [测验](./quizzes/networking/00-networking-overview-quiz.md)
3. [网络基础 — 25 种协议](./basics/06-network-fundamentals-part1.md)
...
4. [Linux 网络诊断实践](./networking/07-linux-network-diagnostics.md) | [测验](./quizzes/networking/07-linux-network-diagnostics-quiz.md)
5. [VPC CNI](./networking/01-vpc-cni.md) | [测验](./quizzes/networking/01-vpc-cni-quiz.md)
6. **Cilium 深入解析**
...
8. [VPC Lattice](./networking/02-vpc-lattice.md) | [测验](./quizzes/networking/02-vpc-lattice-quiz.md)
9. [AWS Load Balancer Controller](./networking/03-aws-lb-controller.md) | [测验](./quizzes/networking/03-aws-lb-controller-quiz.md)
10. [Gateway API](./networking/04-gateway-api.md) | [测验](./quizzes/networking/04-gateway-api-quiz.md)
11. [跨组织 VPC 连接](./networking/05-cross-org-vpc-connectivity.md) | [测验](./quizzes/networking/05-cross-org-vpc-connectivity-quiz.md)
12. [Pod 网络基准测试](./networking/06-pod-network-benchmark.md) | [测验](./quizzes/networking/06-pod-network-benchmark-quiz.md)
...
2. [EKS 上 ClickHouse 实测基准测试](./database/01-clickhouse-on-eks.md) | [测验](./quizzes/database/01-clickhouse-on-eks-quiz.md)
...
2. **EKS 上 Kafka 深入解析**
   - [EKS 上 Kafka 简介](./data-on-eks/kafka/README.md)
...
3. **EKS 上 Spark 深入解析**
   - [EKS 上 Spark 简介](./data-on-eks/spark/README.md)
   - [第 1 部分：Kubernetes 上 Spark 基础](./data-on-eks/spark/01-spark-fundamentals.md) | [测验](./quizzes/data-on-eks/spark/01-spark-fundamentals-quiz.md)
   - [第 2 部分：Spark Operator](./data-on-eks/spark/02-spark-operator.md) | [测验](./quizzes/data-on-eks/spark/02-spark-operator-quiz.md)
   - [第 3 部分：EKS 上 Amazon EMR](./data-on-eks/spark/03-emr-on-eks.md) | [测验](./quizzes/data-on-eks/spark/03-emr-on-eks-quiz.md)
...
4. **EKS 上 Airflow 深入解析**
   - [EKS 上 Airflow 简介](./data-on-eks/airflow/README.md)
...
5. **EKS 上 Flink 深入解析**
   - [EKS 上 Flink 简介](./data-on-eks/flink/README.md)
...
8. **EKS 上 Ray 深入解析**
   - [EKS 上 Ray 简介](./ai-ml/ray/README.md)
...
9. **EKS 上 Kubeflow 深入解析**
   - [EKS 上 Kubeflow 简介](./ai-ml/kubeflow/README.md)
...
10. **EKS 上 MLflow 深入解析**
   - [EKS 上 MLflow 简介](./ai-ml/mlflow/README.md)
...
2. [Kubernetes 的 AWS Controllers (ACK)](./platform-engineering/02-ack.md) | [测验](./quizzes/platform-engineering/02-ack-quiz.md)
...
3. **日志**
   - [日志概览](./observability/logging/README.md) | [测验](./quizzes/observability/logging/README-quiz.md)
...
我们提供动手实验指南，帮助您在学完理论后于真实环境中进行实践。
