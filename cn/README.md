> [韩文版](https://www.atomai.click/kubernetes-docs/ko/)

# Kubernetes 与 Amazon EKS 培训内容
[![GitBook](https://img.shields.io/static/v1?message=Documented%20on%20GitBook&logo=gitbook&logoColor=ffffff&label=%20&labelColor=5c5c5c&color=3F89A1)](https://www.gitbook.com/preview?utm_source=gitbook_readme_badge&utm_medium=organic&utm_campaign=preview_documentation&utm_content=link)

本仓库是一本全面的云技术指南，内容涵盖 Linux 与容器基础、Kubernetes 与 Amazon EKS、网络、服务网格（Service Mesh）、存储、数据库、数据管道、AI/ML 以及安全与运维。除学习资料之外，还提供在真实 AWS 环境中实测得到的基准测试数据，以及各主题的测验和精选实操实验（Lab）。

## 学习资料与测验

本培训内容在提供学习资料的同时，还为每个主题配备了测验。你可以通过测验来检验并巩固所学内容。每个测验都采用折叠式答案设计，答案默认隐藏，便于你先自行作答，然后再查看答案。

- [学习资料目录](#table-of-contents) - 按主题划分的学习资料
- [测验合集](./quizzes/README.md) - 按主题划分的测验
- [指南路线图](./roadmap.md) - 完整的学习地图与推荐学习路径 | [测验](./quizzes/roadmap-quiz.md)
- [借助 LLM 阅读](./llm-guide.md) - 通过 llms.txt、清单（manifest）和 MCP 查找并阅读原始资料 | [测验](./quizzes/llm-guide-quiz.md)

## 目录

### 新闻
- [每周新闻](./news/README.md) - 最新的 Kubernetes/EKS 生态新闻摘要
...
4. [eBPF 基础与实践应用](./basics/05-ebpf-fundamentals.md) | [测验](./quizzes/basics/05-ebpf-fundamentals-quiz.md)

### Linux 内核
1. [Linux 内核概述](./kernel/README.md)
2. [容器背后的内核特性](./kernel/01-container-primitives.md) | [测验](./quizzes/kernel/01-container-primitives-quiz.md)
3. [内核网络栈](./kernel/02-network-stack.md) | [测验](./quizzes/kernel/02-network-stack-quiz.md)
4. [EKS 节点内核调优](./kernel/03-eks-node-tuning.md) | [测验](./quizzes/kernel/03-eks-node-tuning-quiz.md)

### Kubernetes 核心概念
1. [Kubernetes 简介](./basics/04-kubernetes-introduction.md) | [测验](./quizzes/basics/04-kubernetes-introduction-quiz.md)
2. [集群架构](./core/01-cluster-architecture.md) | [测验](./quizzes/core/01-cluster-architecture-quiz.md)
3. [Pod 与工作负载](./core/02-pods-and-workloads.md) | [测验](./quizzes/core/02-pods-and-workloads-quiz.md)
4. [Service 与网络](./core/03-services-networking.md) | [测验](./quizzes/core/03-services-networking-quiz.md)
5. [存储](./core/04-storage.md) | [测验](./quizzes/core/04-storage-quiz.md)
6. [配置](./core/05-configuration-secrets.md) | [测验](./quizzes/core/05-configuration-secrets-quiz.md)
7. [安全](./core/06-security.md) | [测验](./quizzes/core/06-security-quiz.md)
8. [策略](./core/07-policies.md) | [测验](./quizzes/core/07-policies-quiz.md)
9. [调度、抢占与驱逐](./core/08-scheduling-preemption-eviction.md) | [测验](./quizzes/core/08-scheduling-preemption-eviction-quiz.md)
10. [集群管理](./core/09-cluster-administration.md) | [测验](./quizzes/core/09-cluster-administration-quiz.md)
11. [Kubernetes 中的 Windows](./core/10-windows-in-kubernetes.md) | [测验](./quizzes/core/10-windows-in-kubernetes-quiz.md)
12. [扩展 Kubernetes](./core/11-extending-kubernetes.md) | [测验](./quizzes/core/11-extending-kubernetes-quiz.md)
13. 自定义调度器
   - [第 1 部分：自定义调度器基础](./scheduling/01-custom-scheduler-part1.md) | [测验](./quizzes/scheduling/02-custom-scheduler-part1-quiz.md)
   - [第 2 部分：调度器扩展与框架](./scheduling/02-custom-scheduler-part2.md) | [测验](./quizzes/scheduling/02-custom-scheduler-part2-quiz.md)
   - [第 3 部分：自定义调度器实现示例与监控](./scheduling/03-custom-scheduler-part3.md) | [测验](./quizzes/scheduling/02-custom-scheduler-part3-quiz.md)
14. 自动扩缩容
   - [KEDA](./autoscaling/01-keda.md) | [测验](./quizzes/autoscaling/05-keda-quiz.md)
   - [Karpenter](./autoscaling/02-karpenter.md) | [测验](./quizzes/autoscaling/06-karpenter-quiz.md)
   - [Knative](./autoscaling/03-knative.md) | [测验](./quizzes/autoscaling/03-knative-quiz.md)

### Amazon EKS
1. [EKS 简介](./eks/01-eks-introduction.md) | [测验](./quizzes/eks/01-eks-introduction-quiz.md)
2. EKS 集群创建
   - [第 1 部分：前置条件](./eks/02-eks-cluster-creation-part1.md) | [测验](./quizzes/eks/02-eks-cluster-creation-part1-quiz.md)
   - [第 2 部分：使用 eksctl 创建集群](./eks/02-eks-cluster-creation-part2.md) | [测验](./quizzes/eks/02-eks-cluster-creation-part2-quiz.md)
   - [第 3 部分：使用 AWS 管理控制台和 CLI 创建集群](./eks/02-eks-cluster-creation-part3.md) | [测验](./quizzes/eks/02-eks-cluster-creation-part3-quiz.md)
   - [第 4 部分：使用 Terraform 和 CDK 创建集群](./eks/02-eks-cluster-creation-part4.md) | [测验](./quizzes/eks/02-eks-cluster-creation-part4-quiz.md)
   - [第 5 部分：集群访问、验证、升级与删除](./eks/02-eks-cluster-creation-part5.md) | [测验](./quizzes/eks/02-eks-cluster-creation-part5-quiz.md)
3. EKS 网络
   - [第 1 部分：基本概念与 VPC 配置](./eks/03-eks-networking-part1.md) | [测验](./quizzes/eks/03-eks-networking-part1-quiz.md)
   - [第 2 部分：Service 与负载均衡、网络策略](./eks/03-eks-networking-part2.md) | [测验](./quizzes/eks/03-eks-networking-part2-quiz.md)
...
4. EKS 存储
   ...
   - [第 2 部分：FSx for Lustre、S3、快照、卷扩容、性能优化](./eks/04-eks-storage-part2.md) | [测验](./quizzes/eks/04-eks-storage-part2-quiz.md)
...
6. [EKS 监控与日志](./eks/06-eks-monitoring-logging.md) | [测验](./quizzes/eks/06-eks-monitoring-logging-quiz.md)
...
10. [EKS 弹性与高可用](./eks/10-eks-resiliency.md) | [测验](./quizzes/eks/10-eks-resiliency-quiz.md)
11. [EKS 高级调试](./eks/11-eks-advanced-debugging.md) | [测验](./quizzes/eks/11-eks-advanced-debugging-quiz.md)
12. [Kubernetes 版本特性与路线图](./eks/12-kubernetes-version-roadmap.md) | [测验](./quizzes/eks/12-kubernetes-version-roadmap-quiz.md)

### EKS Hybrid Nodes
1. [EKS Hybrid Nodes 简介](./eks-hybrid-nodes/README.md)
2. [前置条件](./eks-hybrid-nodes/01-prerequisites.md) | [测验](./quizzes/eks-hybrid-nodes/01-prerequisites-quiz.md)
3. [网络配置](./eks-hybrid-nodes/02-network-configuration.md) | [测验](./quizzes/eks-hybrid-nodes/02-network-configuration-quiz.md)
4. [气隙（Air-Gap）环境搭建](./eks-hybrid-nodes/03-airgap-setup.md) | [测验](./quizzes/eks-hybrid-nodes/03-airgap-setup-quiz.md)
...
9. [运维与维护](./eks-hybrid-nodes/08-operations.md) | [测验](./quizzes/eks-hybrid-nodes/08-operations-quiz.md)
10. [裸金属操作系统搭建](./eks-hybrid-nodes/09-bare-metal-os-setup.md) | [测验](./quizzes/eks-hybrid-nodes/09-bare-metal-os-setup-quiz.md)
11. [Hybrid Nodes 网关](./eks-hybrid-nodes/10-hybrid-nodes-gateway.md) | [测验](./quizzes/eks-hybrid-nodes/10-hybrid-nodes-gateway-quiz.md)

### EKS Auto Mode
1. [EKS Auto Mode 简介](./eks-auto-mode/README.md)
2. [快速入门](./eks-auto-mode/01-getting-started.md) | [测验](./quizzes/eks-auto-mode/01-getting-started-quiz.md)
...
5. [Spot 实例策略](./eks-auto-mode/04-spot-strategies.md) | [测验](./quizzes/eks-auto-mode/04-spot-strategies-quiz.md)
6. [运维与管理](./eks-auto-mode/05-operations.md) | [测验](./quizzes/eks-auto-mode/05-operations-quiz.md)
...
### 网络
1. [Kubernetes 网络概述](./networking/README.md) | [测验](./quizzes/networking/00-networking-overview-quiz.md)
2. [网络基础 —— 25 种协议](./basics/06-network-fundamentals-part1.md)
   - [第 1 部分：分层模型、链路层与路由层](./basics/06-network-fundamentals-part1.md) | [测验](./quizzes/basics/06-network-fundamentals-part1-quiz.md)
   - [第 2 部分：传输层与 TLS](./basics/06-network-fundamentals-part2.md) | [测验](./quizzes/basics/06-network-fundamentals-part2-quiz.md)
   - [第 3 部分：应用层协议](./basics/06-network-fundamentals-part3.md) | [测验](./quizzes/basics/06-network-fundamentals-part3-quiz.md)
   - [第 4 部分：一次请求的旅程与云](./basics/06-network-fundamentals-part4.md) | [测验](./quizzes/basics/06-network-fundamentals-part4-quiz.md)
3. [Linux 网络诊断实践](./networking/07-linux-network-diagnostics.md) | [测验](./quizzes/networking/07-linux-network-diagnostics-quiz.md)
4. [VPC CNI](./networking/01-vpc-cni.md) | [测验](./quizzes/networking/01-vpc-cni-quiz.md)
5. **Cilium 深入解析**
   ...
   - [第 4 部分：IPAM 与策略](./networking/cilium/04-ipam-policy.md) | [测验](./quizzes/networking/cilium/04-ipam-policy-quiz.md)
   - [第 5 部分：L2-L7 网络](./networking/cilium/05-l2-l7-networking.md) | [测验](./quizzes/networking/cilium/05-l2-l7-networking-quiz.md)
   - [第 6 部分：安全与可见性](./networking/cilium/06-security-visibility.md) | [测验](./quizzes/networking/cilium/06-security-visibility-quiz.md)
...
6. **Calico 深入解析**
   ...
   - [第 5 部分：网络策略（Network Policy）](./networking/calico/05-network-policy.md) | [测验](./quizzes/networking/calico/05-network-policy-quiz.md)
...
7. [VPC Lattice](./networking/02-vpc-lattice.md) | [测验](./quizzes/networking/02-vpc-lattice-quiz.md)
8. [AWS Load Balancer Controller](./networking/03-aws-lb-controller.md) | [测验](./quizzes/networking/03-aws-lb-controller-quiz.md)
9. [Gateway API](./networking/04-gateway-api.md) | [测验](./quizzes/networking/04-gateway-api-quiz.md)
10. [跨组织 VPC 互联](./networking/05-cross-org-vpc-connectivity.md) | [测验](./quizzes/networking/05-cross-org-vpc-connectivity-quiz.md)
11. [Pod 网络基准测试](./networking/06-pod-network-benchmark.md) | [测验](./quizzes/networking/06-pod-network-benchmark-quiz.md)
...
4. **VPC Lattice 深入解析**
   - [VPC Lattice 深入解析概览](./service-mesh/vpc-lattice/README.md)
   - [App Mesh 与 VPC Lattice 架构对比](./service-mesh/vpc-lattice/01-appmesh-vs-lattice.md) | [测验](./quizzes/service-mesh/vpc-lattice/01-appmesh-vs-lattice-quiz.md)
   - [延迟影响分析](./service-mesh/vpc-lattice/02-latency.md) | [测验](./quizzes/service-mesh/vpc-lattice/02-latency-quiz.md)
   - [IAM 认证流程](./service-mesh/vpc-lattice/03-auth-flow.md) | [测验](./quizzes/service-mesh/vpc-lattice/03-auth-flow-quiz.md)
   - [基础知识 —— 链路本地地址与 SNI](./service-mesh/vpc-lattice/04-networking-basics.md) | [测验](./quizzes/service-mesh/vpc-lattice/04-networking-basics-quiz.md)
   - [工作负载身份迁移](./service-mesh/vpc-lattice/05-spiffe-to-iam.md) | [测验](./quizzes/service-mesh/vpc-lattice/05-spiffe-to-iam-quiz.md)
   - [约束与决策要点](./service-mesh/vpc-lattice/06-constraints.md) | [测验](./quizzes/service-mesh/vpc-lattice/06-constraints-quiz.md)
   - [内核数据路径](./service-mesh/vpc-lattice/07-kernel-datapath.md) | [测验](./quizzes/service-mesh/vpc-lattice/07-kernel-datapath-quiz.md)

### 存储
1. [存储概述](./storage/README.md)
2. [EBS gp2 与 gp3 实测基准测试](./storage/01-ebs-gp2-gp3-benchmark.md) | [测验](./quizzes/storage/01-ebs-gp2-gp3-benchmark-quiz.md)

### 数据库
1. [Kubernetes 上的数据库概述](./database/README.md)
2. [ClickHouse on EKS 实测基准测试](./database/01-clickhouse-on-eks.md) | [测验](./quizzes/database/01-clickhouse-on-eks-quiz.md)

### 区块链
1. [区块链概述](./blockchain/README.md)
2. [区块链基础](./blockchain/01-fundamentals.md) | [测验](./quizzes/blockchain/01-fundamentals-quiz.md)
3. [在 EKS 上运行区块链节点](./blockchain/02-nodes-on-eks.md) | [测验](./quizzes/blockchain/02-nodes-on-eks-quiz.md)
4. [Amazon Managed Blockchain](./blockchain/03-managed-blockchain.md) | [测验](./quizzes/blockchain/03-managed-blockchain-quiz.md)
5. [金融服务视角](./blockchain/04-financial-services.md) | [测验](./quizzes/blockchain/04-financial-services-quiz.md)

### 数据管道
1. [Data on EKS 概述](./data-on-eks/README.md)
   - [现代数据管道剖析](./data-on-eks/01-data-pipeline-anatomy.md) | [测验](./quizzes/data-on-eks/01-data-pipeline-anatomy-quiz.md)
   - [SageMaker Unified Studio 治理](./data-on-eks/sagemaker-unified-studio/README.md)
   - [第 4 部分：Domain、Project 与成员治理](./data-on-eks/sagemaker-unified-studio/01-domains-projects-governance.md) | [测验](./quizzes/data-on-eks/sagemaker-unified-studio/01-domains-projects-governance-quiz.md)
2. **Kafka on EKS 深入解析**
   ...
   - [第 5 部分：Kafka Connect 与 MirrorMaker](./data-on-eks/kafka/05-kafka-connect-mirrormaker.md) | [测验](./quizzes/data-on-eks/kafka/05-kafka-connect-mirrormaker-quiz.md)
   ...
   - [第 9 部分：Kafka 实测基准测试](./data-on-eks/kafka/09-kafka-benchmark.md) | [测验](./quizzes/data-on-eks/kafka/09-kafka-benchmark-quiz.md)
3. **Spark on EKS 深入解析**
   - [Spark on EKS 简介](./data-on-eks/spark/README.md)
   - [第 1 部分：Spark on Kubernetes 基础](./data-on-eks/spark/01-spark-fundamentals.md) | [测验](./quizzes/data-on-eks/spark/01-spark-fundamentals-quiz.md)
   - [第 2 部分：Spark Operator](./data-on-eks/spark/02-spark-operator.md) | [测验](./quizzes/data-on-eks/spark/02-spark-operator-quiz.md)
   - [第 3 部分：Amazon EMR on EKS](./data-on-eks/spark/03-emr-on-eks.md) | [测验](./quizzes/data-on-eks/spark/03-emr-on-eks-quiz.md)
   - [第 4 部分：性能与成本调优](./data-on-eks/spark/04-performance-tuning.md) | [测验](./quizzes/data-on-eks/spark/04-performance-tuning-quiz.md)
   - [第 5 部分：最佳实践与安全](./data-on-eks/spark/05-best-practices.md) | [测验](./quizzes/data-on-eks/spark/05-best-practices-quiz.md)
4. **Airflow on EKS 深入解析**
   - [Airflow on EKS 简介](./data-on-eks/airflow/README.md)
   ...
   - [第 2 部分：Helm 部署与 Executor 选型](./data-on-eks/airflow/02-helm-deployment.md) | [测验](./quizzes/data-on-eks/airflow/02-helm-deployment-quiz.md)
   - [第 3 部分：DAG 模式与 KubernetesPodOperator](./data-on-eks/airflow/03-dag-patterns.md) | [测验](./quizzes/data-on-eks/airflow/03-dag-patterns-quiz.md)
   ...
   - [第 5 部分：运维与安全](./data-on-eks/airflow/05-operations.md) | [测验](./quizzes/data-on-eks/airflow/05-operations-quiz.md)
5. **Flink on EKS 深入解析**
   - [Flink on EKS 简介](./data-on-eks/flink/README.md)
   ...
   - [第 3 部分：状态、检查点与流式处理模式](./data-on-eks/flink/03-state-checkpointing-streaming.md) | [测验](./quizzes/data-on-eks/flink/03-state-checkpointing-streaming-quiz.md)
   - [第 4 部分：运维、高可用与 Managed Flink](./data-on-eks/flink/04-operations-ha.md) | [测验](./quizzes/data-on-eks/flink/04-operations-ha-quiz.md)
...
5. [vLLM 部署与优化](./ai-ml/02-vllm-deployment.md) | [测验](./quizzes/ai-ml/04-vllm-deployment-quiz.md)
...
8. **Ray on EKS 深入解析**
   - [Ray on EKS 简介](./ai-ml/ray/README.md)
   ...
   - [第 3 部分：Ray Train 与 Ray Tune](./ai-ml/ray/03-ray-train-tune.md) | [测验](./quizzes/ai-ml/ray/03-ray-train-tune-quiz.md)
   - [第 4 部分：Ray Serve](./ai-ml/ray/04-ray-serve.md) | [测验](./quizzes/ai-ml/ray/04-ray-serve-quiz.md)
9. **Kubeflow on EKS 深入解析**
   - [Kubeflow on EKS 简介](./ai-ml/kubeflow/README.md)
   - [第 1 部分：Kubeflow 架构与在 EKS 上的安装](./ai-ml/kubeflow/01-architecture-installation.md) | [测验](./quizzes/ai-ml/kubeflow/01-architecture-installation-quiz.md)
   ...
   - [第 4 部分：Katib —— 超参数调优与 AutoML](./ai-ml/kubeflow/04-katib.md) | [测验](./quizzes/ai-ml/kubeflow/04-katib-quiz.md)
   - [第 5 部分：Kubeflow Trainer 与分布式训练](./ai-ml/kubeflow/05-training-operator.md) | [测验](./quizzes/ai-ml/kubeflow/05-training-operator-quiz.md)
   - [第 6 部分：KServe —— Kubernetes 上的模型服务](./ai-ml/kubeflow/06-kserve.md) | [测验](./quizzes/ai-ml/kubeflow/06-kserve-quiz.md)
10. **MLflow on EKS 深入解析**
   - [MLflow on EKS 简介](./ai-ml/mlflow/README.md)
...
11. **SageMaker AI Qwen PII 指南**
   - [指南简介](./ai-ml/sagemaker-ai/README.md)
   - [第 1 部分：平台架构](./ai-ml/sagemaker-ai/01-platform-architecture.md) | [测验](./quizzes/ai-ml/sagemaker-ai/01-platform-architecture-quiz.md)
   - [第 2 部分：合成 PII 数据与令牌化](./ai-ml/sagemaker-ai/02-pii-data-tokenization.md) | [测验](./quizzes/ai-ml/sagemaker-ai/02-pii-data-tokenization-quiz.md)
   - [第 3 部分：SageMaker AI 与 MLflow 执行](./ai-ml/sagemaker-ai/03-sagemaker-mlflow-execution.md) | [测验](./quizzes/ai-ml/sagemaker-ai/03-sagemaker-mlflow-execution-quiz.md)
   - [第 4 部分：Unified Studio 治理](./data-on-eks/sagemaker-unified-studio/01-domains-projects-governance.md) | [测验](./quizzes/data-on-eks/sagemaker-unified-studio/01-domains-projects-governance-quiz.md)
   - [第 5 部分：事实性验证结果](./ai-ml/sagemaker-ai/04-validation-results.md) | [测验](./quizzes/ai-ml/sagemaker-ai/04-validation-results-quiz.md)
12. [LLM Gateway（Inference Gateway）深入解析](./ai-ml/08-llm-gateway.md) | [测验](./quizzes/ai-ml/08-llm-gateway-quiz.md)

### 安全与策略
1. [使用 Kyverno 进行策略管理](./security/01-kyverno-policy-management.md) | [测验](./quizzes/security/01-kyverno-policy-management-quiz.md)
2. [Kubernetes 认证与授权](./security/02-kubernetes-auth-authz.md) | [测验](./quizzes/security/02-kubernetes-auth-authz-quiz.md)
3. [Pod Security Standards](./security/03-pod-security-standards.md) | [测验](./quizzes/security/03-pod-security-standards-quiz.md)
4. [网络策略](./security/04-network-policies.md) | [测验](./quizzes/security/04-network-policies-quiz.md)
5. [Secret 管理](./security/05-secrets-management.md) | [测验](./quizzes/security/05-secrets-management-quiz.md)
...
2. **ArgoCD**
   ...
   - [Applications](./gitops/argocd/02-applications.md) | [测验](./quizzes/gitops/argocd/02-applications-quiz.md)
   ...
   - [Projects 与 RBAC](./gitops/argocd/06-projects-rbac.md) | [测验](./quizzes/gitops/argocd/06-projects-rbac-quiz.md)
   ...
   - [Rollouts Experiments 深入解析](./gitops/argocd/10-rollouts-experiment.md) | [测验](./quizzes/gitops/argocd/10-rollouts-experiment-quiz.md)
...
6. [功能开关与 OpenFeature](./gitops/05-feature-flags.md) | [测验](./quizzes/gitops/05-feature-flags-quiz.md)

### 企业云治理
1. [治理概述](./governance/00-governance-overview.md) | [测验](./quizzes/governance/00-governance-overview-quiz.md)
2. [Landing Zone、OU 与组织级管控](./governance/01-landing-zone-and-ou.md) | [测验](./quizzes/governance/01-landing-zone-and-ou-quiz.md)
3. [账户结构与 IAM 边界](./governance/02-account-and-iam.md) | [测验](./quizzes/governance/02-account-and-iam-quiz.md)
4. [多账户、多集群 EKS 架构](./governance/03-eks-multi-account-multi-cluster.md) | [测验](./quizzes/governance/03-eks-multi-account-multi-cluster-quiz.md)
5. [共享 VPC 与互联](./governance/04-shared-vpc-and-connectivity.md) | [测验](./quizzes/governance/04-shared-vpc-and-connectivity-quiz.md)
6. [数据与安全边界](./governance/05-data-security-boundaries.md) | [测验](./quizzes/governance/05-data-security-boundaries-quiz.md)
7. [决策框架与 PoC 设计](./governance/06-decision-framework-and-poc.md) | [测验](./quizzes/governance/06-decision-framework-and-poc-quiz.md)

### 平台工程
0. [平台工程概述](./platform-engineering/00-platform-engineering-overview.md) | [测验](./quizzes/platform-engineering/00-platform-engineering-overview-quiz.md)
...
### 容器镜像仓库
1. [容器镜像仓库概述](./container-registry/README.md)
...
### 可观测性
1. [可观测性概述](./observability/README.md)
2. **指标**
   - [指标概述](./observability/metrics/README.md) | [测验](./quizzes/observability/metrics/00-metrics-overview-quiz.md)
...
3. **日志**
   - [日志概述](./observability/logging/README.md) | [测验](./quizzes/observability/logging/README-quiz.md)
   ...
   - [日志采集器](./observability/logging/05-collectors.md) | [测验](./quizzes/observability/logging/05-collectors-quiz.md)
4. **链路追踪**
   - [链路追踪概述](./observability/tracing/README.md)
...
5. **告警**
   - [告警概述](./observability/alerting/README.md)
...
### 运维指南
1. [基础设施搭建](./ops/01-infrastructure-setup.md) | [测验](./quizzes/ops/01-infrastructure-setup-quiz.md)
2. [基础设施进阶](./ops/02-infrastructure-advanced.md) | [测验](./quizzes/ops/02-infrastructure-advanced-quiz.md)
3. [CI 流水线](./ops/03-ci-pipelines.md) | [测验](./quizzes/ops/03-ci-pipelines-quiz.md)
...
15. [单可用区集群运维](./ops/15-zonal-operations-guide.md) | [测验](./quizzes/ops/15-zonal-operations-guide-quiz.md)
16. [故障排查手册](./ops/16-troubleshooting-playbook.md) | [测验](./quizzes/ops/16-troubleshooting-playbook-quiz.md)
17. [EKS Spot 生产环境实验与结果评估](./ops/17-spot-production-experiments.md) | [测验](./quizzes/ops/17-spot-production-experiments-quiz.md)

## 实验指南

我们提供实操实验指南，便于你在学完理论后于真实环境中动手练习。
...
2. [第 1 部分：基础设施搭建](./labs/observability/01-infrastructure-setup-lab.md) | [测验](./quizzes/observability/labs/01-infrastructure-setup-quiz.md)
...
4. [第 3 部分：MSA 部署与金丝雀发布](./labs/observability/03-msa-deployment-lab.md) | [测验](./quizzes/observability/labs/03-msa-deployment-quiz.md)
5. [第 4 部分：压力测试与自动扩缩容](./labs/observability/04-load-testing-scaling-lab.md) | [测验](./quizzes/observability/labs/04-load-testing-scaling-quiz.md)
6. [第 5 部分：告警与 AIOps](./labs/observability/05-alerting-aiops-lab.md) | [测验](./quizzes/observability/labs/05-alerting-aiops-quiz.md)
...
### 初学者学习路径
1. 按以下顺序学习：**Linux 与容器** -> **Kubernetes 核心概念** -> **Amazon EKS**
2. 读完每一章后，做对应的测验来检验理解程度
3. 在练习环境中动手执行命令和示例代码

### 进阶用户学习路径
1. 按以下顺序学习：**Amazon EKS** -> **AI/ML** -> **服务网格（Service Mesh）** -> **安全与策略**
2. 通过 **Cilium** 章节深入学习网络
3. 聚焦特定工具或技术进行深入学习

### 测验使用方法
- 点击每篇文档末尾的测验链接来检验学习效果
- 先自行思考折叠式答案，再展开查看
- 对于答错的题目，回顾对应的文档
