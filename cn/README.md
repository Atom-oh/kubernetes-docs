...
本仓库是一份全面的云指南，涵盖 Linux 和容器基础知识、Kubernetes 和 Amazon EKS、网络、Service Mesh、存储、数据库、数据管道、AI/ML，以及安全与运维。除学习资料外，还提供在真实 AWS 环境中测得的基准测试数据、主题测验和精选实践实验。

## 学习资料和测验

本培训内容为每个主题提供学习资料及测验。您可以通过测验检验并巩固所学知识。每项测验都采用隐藏答案的切换式设计，让您可以先尝试作答，再查看答案。

- [学习资料目录](#table-of-contents) - 按主题分类的学习资料
- [测验合集](./quizzes/README.md) - 按主题分类的测验
...
4. [EKS Node 内核调优](./kernel/03-eks-node-tuning.md) | [测验](./quizzes/kernel/03-eks-node-tuning-quiz.md)
...
3. EKS 网络
   ...
   - [第 3 部分：性能优化、故障排查和高级使用场景](./eks/03-eks-networking-part3.md) | [测验](./quizzes/eks/03-eks-networking-part3-quiz.md)
4. EKS 存储
   ...
   - [第 3 部分：监控、故障排查、成本优化和安全](./eks/04-eks-storage-part3.md) | [测验](./quizzes/eks/04-eks-storage-part3-quiz.md)
...
5. [Node 引导](./eks-hybrid-nodes/04-node-bootstrap.md) | [测验](./quizzes/eks-hybrid-nodes/04-node-bootstrap-quiz.md)
...
### 网络
1. [网络概述](./networking/README.md) | [测验](./quizzes/networking/00-networking-overview-quiz.md)
...
3. [VPC CNI](./networking/01-vpc-cni.md) | [测验](./quizzes/networking/01-vpc-cni-quiz.md)
4. **Cilium 深入解析**
...
6. [VPC Lattice](./networking/02-vpc-lattice.md) | [测验](./quizzes/networking/02-vpc-lattice-quiz.md)
7. [AWS Load Balancer Controller](./networking/03-aws-lb-controller.md) | [测验](./quizzes/networking/03-aws-lb-controller-quiz.md)
8. [Gateway API](./networking/04-gateway-api.md) | [测验](./quizzes/networking/04-gateway-api-quiz.md)
9. [跨组织 VPC 连接](./networking/05-cross-org-vpc-connectivity.md) | [测验](./quizzes/networking/05-cross-org-vpc-connectivity-quiz.md)
10. [Pod 网络基准测试](./networking/06-pod-network-benchmark.md) | [测验](./quizzes/networking/06-pod-network-benchmark-quiz.md)
...
4. **VPC Lattice 深入解析**
   ...
   - [约束条件和决策点](./service-mesh/vpc-lattice/06-constraints.md) | [测验](./quizzes/service-mesh/vpc-lattice/06-constraints-quiz.md)
...
3. [在 EKS 上运行区块链 Node](./blockchain/02-nodes-on-eks.md) | [测验](./quizzes/blockchain/02-nodes-on-eks-quiz.md)
...
1. [EKS 上的数据概述](./data-on-eks/README.md)
   ...
   - [第 4 部分：Domain、Project 和成员资格治理](./data-on-eks/sagemaker-unified-studio/01-domains-projects-governance.md) | [测验](./quizzes/data-on-eks/sagemaker-unified-studio/01-domains-projects-governance-quiz.md)
2. **EKS 上的 Kafka 深入解析**
...
5. **EKS 上的 Flink 深入解析**
   ...
   - [第 3 部分：状态、检查点和流式处理模式](./data-on-eks/flink/03-state-checkpointing-streaming.md) | [测验](./quizzes/data-on-eks/flink/03-state-checkpointing-streaming-quiz.md)
...
9. **EKS 上的 Kubeflow 深入解析**
   ...
   - [第 1 部分：EKS 上的 Kubeflow 架构和安装](./ai-ml/kubeflow/01-architecture-installation.md) | [测验](./quizzes/ai-ml/kubeflow/01-architecture-installation-quiz.md)
...
11. **SageMaker AI Qwen PII 指南**
   ...
   - [第 2 部分：合成 PII 数据和分词](./ai-ml/sagemaker-ai/02-pii-data-tokenization.md) | [测验](./quizzes/ai-ml/sagemaker-ai/02-pii-data-tokenization-quiz.md)
...
7. [第 6 部分：分布式链路追踪分析](./labs/observability/06-distributed-tracing-lab.md) | [测验](./quizzes/observability/labs/06-distributed-tracing-quiz.md)
