...
本仓库是一份全面的云指南，涵盖 Linux 和容器基础、Kubernetes 和 Amazon EKS、网络、服务网格、存储、数据库、数据管道、AI/ML，以及安全与运维。除学习材料外，还提供在真实 AWS 环境中测得的基准数据，以及每个主题的测验和动手实验。

## 学习材料和测验

本培训内容为每个主题提供学习材料和测验。您可以通过测验检验并巩固所学知识。每份测验均采用隐藏答案的切换式设计，让您可以先尝试回答问题，再查看答案。
...
- [使用 LLM 阅读](./llm-guide.md) - 如何通过 llms.txt 将整本指南提供给 AI | [测验](./quizzes/llm-guide-quiz.md)
...
4. [eBPF 基础和实际应用](./basics/05-ebpf-fundamentals.md) | [测验](./quizzes/basics/05-ebpf-fundamentals-quiz.md)
...
2. [网络基础 — 25 种协议](./basics/06-network-fundamentals-part1.md)
   ...
   - [第 4 部分：请求之旅和云](./basics/06-network-fundamentals-part4.md) | [测验](./quizzes/basics/06-network-fundamentals-part4-quiz.md)
...
2. [EKS 上 ClickHouse 的实测基准](./database/01-clickhouse-on-eks.md) | [测验](./quizzes/database/01-clickhouse-on-eks-quiz.md)
...
6. [功能开关和 OpenFeature](./gitops/05-feature-flags.md) | [测验](./quizzes/gitops/05-feature-flags-quiz.md)
...
4. **追踪**
   ...
   - [AWS X-Ray](./observability/tracing/02-xray.md) | [测验](./quizzes/observability/tracing/02-xray.md)
   - [OpenTelemetry](./observability/tracing/03-opentelemetry.md) | [测验](./quizzes/observability/tracing/03-opentelemetry.md)
   - [Dynatrace](./observability/tracing/04-dynatrace.md) | [测验](./quizzes/observability/tracing/04-dynatrace.md)
5. **告警**
...
15. [可用区集群运维](./ops/15-zonal-operations-guide.md) | [测验](./quizzes/ops/15-zonal-operations-quiz.md)
16. [故障排除手册](./ops/16-troubleshooting-playbook.md) | [测验](./quizzes/ops/16-troubleshooting-playbook-quiz.md)

## 实验指南

我们提供动手实验指南，帮助您在学习理论后于真实环境中进行实践。
...
4. [第 3 部分：MSA 部署和金丝雀发布](./labs/observability/03-msa-deployment-lab.md) | [测验](./quizzes/observability/labs/03-msa-deployment-quiz.md)
