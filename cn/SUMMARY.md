...
* [EKS 弹性与高可用性](eks/10-eks-resiliency.md)
* [EKS 高级调试](eks/11-eks-advanced-debugging.md)
* [Kubernetes 版本功能与路线图](eks/12-kubernetes-version-roadmap.md)
...
* [EKS 上的 Ray 深入探讨](ai-ml/ray/README.md)
...
* [EKS 上的 Kubeflow 深入探讨](ai-ml/kubeflow/README.md)
  * [第 1 部分：Kubeflow 架构与在 EKS 上安装](ai-ml/kubeflow/01-architecture-installation.md)
...
* [EKS 上的 MLflow 深入探讨](ai-ml/mlflow/README.md)
...
* [EKS 上的 Kafka 深入探讨](data-on-eks/kafka/README.md)
...
* [Cilium 深入探讨](networking/cilium/README.md)
  ...
  * [第 6 部分：安全与可观测性](networking/cilium/06-security-visibility.md)
...
* [Calico 深入探讨](networking/calico/README.md)
  ...
  * [第 4 部分：BGP 深入探讨](networking/calico/04-bgp-deep-dive.md)
...
* [Istio](service-mesh/istio/README.md)
  * [安装与初始设置](service-mesh/istio/01-installation.md)
  ...
  * [对比指南](service-mesh/istio/comparison/README.md)
    * [Service Mesh 解决方案对比](service-mesh/istio/comparison/01-service-mesh-comparison.md)
...
* [GitOps](gitops/README.md)
  * [ArgoCD](gitops/argocd/README.md)
    ...
    * [项目与 RBAC](gitops/argocd/06-projects-rbac.md)
  ...
  * [Feature Flags 和 OpenFeature](gitops/05-feature-flags.md)
...
* [实验指南简介](labs/README.md)
  ...
  * [端到端可观测性实验](lab-guides/labs/observability-end-to-end/README.md)
    ...
    * [第 3 部分：MSA 部署与 Canary](labs/observability/03-msa-deployment-lab.md)
    * [第 4 部分：负载测试与自动扩缩容](labs/observability/04-load-testing-scaling-lab.md)
...
* Amazon EKS
  ...
  * [EKS 弹性与高可用性测验](quizzes/eks/10-eks-resiliency-quiz.md)
  * [EKS 高级调试测验](quizzes/eks/11-eks-advanced-debugging-quiz.md)
  * [Kubernetes 版本功能与路线图测验](quizzes/eks/12-kubernetes-version-roadmap-quiz.md)
* EKS 混合节点
...
* EKS Auto Mode
  ...
  * [Spot 实例策略测验](quizzes/eks-auto-mode/04-spot-strategies.md)
...
* EKS 上的数据
  ...
  * [第 2 部分：Strimzi Operator 测验](quizzes/data-on-eks/kafka/02-strimzi-operator.md)
  * [第 3 部分：Kafka 运维测验](quizzes/data-on-eks/kafka/03-kafka-operations-quiz.md)
  * [第 4 部分：Schema Registry 测验](quizzes/data-on-eks/kafka/04-schema-registry.md)
  * [第 5 部分：Kafka Connect 和 MirrorMaker 测验](quizzes/data-on-eks/kafka/05-kafka-connect-mirrormaker.md)
  * [第 6 部分：MSK 集成测验](quizzes/data-on-eks/kafka/06-msk-integration.md)
  ...
  * [第 2 部分：Spark Operator 测验](quizzes/data-on-eks/spark/02-spark-operator.md)
  * [第 3 部分：EKS 上的 Amazon EMR 测验](quizzes/data-on-eks/spark/03-emr-on-eks.md)
  * [第 4 部分：性能与成本调优测验](quizzes/data-on-eks/spark/04-performance-tuning.md)
  * [第 5 部分：最佳实践与安全测验](quizzes/data-on-eks/spark/05-best-practices.md)
  ...
  * [第 3 部分：DAG 模式与 KubernetesPodOperator 测验](quizzes/data-on-eks/airflow/03-dag-patterns.md)
  * [第 4 部分：Amazon MWAA 集成测验](quizzes/data-on-eks/airflow/04-mwaa-integration.md)
  * [第 5 部分：运维与安全测验](quizzes/data-on-eks/airflow/05-operations.md)
  ...
  * [第 3 部分：状态、Checkpoint 与流处理模式测验](quizzes/data-on-eks/flink/03-state-checkpointing-streaming.md)
...
* 网络
  ...
  * Cilium 深入探讨
    ...
    * [第 6 部分：安全与可观测性测验](quizzes/networking/cilium/06-security-visibility-quiz.md)
  ...
  * Calico 深入探讨
    ...
    * [第 2 部分：架构测验](quizzes/networking/calico/02-architecture.md)
    * [第 3 部分：网络模式测验](quizzes/networking/calico/03-networking-modes-quiz.md)
    * [第 4 部分：BGP 深入探讨测验](quizzes/networking/calico/04-bgp-deep-dive.md)
    * [第 5 部分：网络策略测验](quizzes/networking/calico/05-network-policy.md)
    * [第 6 部分：eBPF 数据平面测验](quizzes/networking/calico/06-ebpf-dataplane.md)
...
* 安全与策略
  * [使用 Kyverno 管理策略测验](quizzes/security/01-kyverno-policy-management-quiz.md)
  * [Kubernetes 认证与授权测验](quizzes/security/02-kubernetes-auth-authz.md)
  * [Pod 安全标准测验](quizzes/security/03-pod-security-standards-quiz.md)
  * [网络策略测验](quizzes/security/04-network-policies-quiz.md)
  * [Secrets 管理测验](quizzes/security/05-secrets-management-quiz.md)
  ...
  * [Kubescape 测验](quizzes/security/11-kubescape.md)
...
* GitOps
  ...
  * ArgoCD 详细测验
    ...
    * [项目与 RBAC 测验](quizzes/gitops/argocd/06-projects-rbac.md)
  ...
  * [Flagger 渐进式交付测验](quizzes/gitops/04-flagger.md)
  * [Feature Flags 和 OpenFeature 测验](quizzes/gitops/05-feature-flags.md)
* 可观测性
  * 指标
  ...
  * 日志
    * [日志概览测验](quizzes/observability/logging/README-quiz.md)
    ...
    * [CloudWatch Logs 测验](quizzes/observability/logging/03-cloudwatch-logs.md)
    * [ClickHouse 测验](quizzes/observability/logging/04-clickhouse.md)
    * [日志收集器测验](quizzes/observability/logging/05-collectors.md)
  * 追踪
  ...
  * 告警
    ...
    * [CloudWatch Alarms 测验](quizzes/observability/alerting/02-cloudwatch-alarms.md)
  ...
  * 可观测性实验
    ...
    * [MSA 部署与 Canary 测验](quizzes/observability/labs/03-msa-deployment-quiz.md)
...
* 平台工程
  ...
  * [ACK 测验](quizzes/platform-engineering/02-ack.md)
  * [KRO 测验](quizzes/platform-engineering/03-kro-quiz.md)
  * [Kubernetes 扩展机制测验](quizzes/platform-engineering/04-kubernetes-extensions.md)
...
* 运维指南
  ...
  * [GitOps 多集群测验](quizzes/ops/04-gitops-multi-cluster.md)
  * [GitOps 自动化测验](quizzes/ops/05-gitops-automation-quiz.md)
  * [扩缩容策略测验](quizzes/ops/06-scaling-strategies.md)
  * [可观测性告警测验](quizzes/ops/07-observability-alerts.md)
  * [可观测性分析测验](quizzes/ops/08-observability-analysis.md)
  * [可观测性技术栈测验](quizzes/ops/09-observability-stack-quiz.md)
  * [资源优化测验](quizzes/ops/10-resource-optimization.md)
  * [升级运维测验](quizzes/ops/11-upgrade-operations.md)
  * [活动容量规划测验](quizzes/ops/12-event-capacity-planning.md)
