...
* 网络
  ...
  * Calico 深入探讨
    ...
    * [第 4 部分：BGP 深入探讨测验](quizzes/networking/calico/04-bgp-deep-dive-quiz.md)
...
* GitOps
  ...
  * ArgoCD 详细测验
    ...
    * [项目与 RBAC 测验](quizzes/gitops/argocd/06-projects-rbac-quiz.md)
  ...
  * [Feature Flags 和 OpenFeature 测验](quizzes/gitops/05-feature-flags-quiz.md)
* 可观测性
  * 指标
  ...
  * 日志
    ...
    * [日志收集器测验](quizzes/observability/logging/05-collectors-quiz.md)
  * 追踪
