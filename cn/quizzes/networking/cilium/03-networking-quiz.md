...
本文档提供用于测试和验证 Cilium 功能的方法。本文基于 Cilium 版本 1.17 编写，并验证了与 Kubernetes 版本 1.30 及更高版本的兼容性。

## 前提条件

- Kubernetes 集群（1.30 或更高版本）
- 已安装并配置 kubectl
- 已安装 Cilium CLI
- Helm 3.12 或更高版本（可选）
...
- [Cilium Network Policy 示例](https://docs.cilium.io/en/stable/policy/language/)
