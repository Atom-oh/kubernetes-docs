...
- [推理框架测验](./ai-ml/04-inference-frameworks-quiz.md)
- [vLLM Deployment 测验](./ai-ml/04-vllm-deployment-quiz.md)
- [在 EKS 上进行模型训练测验](./ai-ml/05-model-training-quiz.md)
...
- [第 4 部分：Katib — 超参数调优和 AutoML 测验](./ai-ml/kubeflow/04-katib-quiz.md)
- [Kubeflow Trainer 和分布式训练测验](./ai-ml/kubeflow/05-training-operator-quiz.md)
- [KServe 测验](./ai-ml/kubeflow/06-kserve-quiz.md)
- [MLflow Tracking 测验](./ai-ml/mlflow/01-tracking-quiz.md)
- [MLflow Model Registry 测验](./ai-ml/mlflow/02-model-registry-quiz.md)
- [MLflow EKS Deployment 测验](./ai-ml/mlflow/03-eks-deployment-quiz.md)
- [Ray 架构测验](./ai-ml/ray/01-architecture-quiz.md)
...
- [Knative 测验](./autoscaling/03-knative-quiz.md)
- [KEDA 测验](./autoscaling/05-keda-quiz.md)
- [Karpenter 测验](./autoscaling/06-karpenter-quiz.md)
...
- [集群架构测验](./core/01-cluster-architecture-quiz.md)
- [Pod 和工作负载测验](./core/02-pods-and-workloads-quiz.md)
- [Service 和网络测验](./core/03-services-networking-quiz.md)
- [存储测验](./core/04-storage-quiz.md)
- [配置测验](./core/05-configuration-secrets-quiz.md)
- [安全测验](./core/06-security-quiz.md)
...
- [Schema Registry 测验](./data-on-eks/kafka/04-schema-registry-quiz.md)
- [Kafka Connect 和 MirrorMaker 测验](./data-on-eks/kafka/05-kafka-connect-mirrormaker-quiz.md)
...
- [EKS 集群创建测验 - 第 4 部分](./eks/02-eks-cluster-creation-part4-quiz.md)
- [EKS 集群创建测验 - 第 5 部分](./eks/02-eks-cluster-creation-part5-quiz.md)
- [EKS 网络测验 - 第 1 部分](./eks/03-eks-networking-part1-quiz.md)
- [EKS 网络测验 - 第 2 部分](./eks/03-eks-networking-part2-quiz.md)
- [EKS 网络测验 - 第 3 部分](./eks/03-eks-networking-part3-quiz.md)
- [EKS 存储测验 - 第 1 部分](./eks/04-eks-storage-part1-quiz.md)
...
- [Amazon EKS 高可用性和弹性测验](./eks/10-eks-resiliency-quiz.md)
- [Amazon EKS 高级调试测验](./eks/11-eks-advanced-debugging-quiz.md)
- [Kubernetes 版本功能和路线图测验](./eks/12-kubernetes-version-roadmap-quiz.md)

### EKS Auto Mode

- [EKS Auto Mode 入门测验](./eks-auto-mode/01-getting-started-quiz.md)
- [EKS Auto Mode NodePool 配置测验](./eks-auto-mode/02-nodepool-configuration-quiz.md)
- [EKS Auto Mode 扩缩容行为测验](./eks-auto-mode/03-scaling-behavior-quiz.md)
...
- [ArgoCD 项目和 RBAC 测验](./gitops/argocd/06-projects-rbac-quiz.md)
...
- [Kubernetes 网络概览测验](./networking/00-networking-overview-quiz.md)
- [Amazon VPC CNI 测验](./networking/01-vpc-cni-quiz.md)
- [VPC Lattice 测验](./networking/02-vpc-lattice-quiz.md)
- [AWS Load Balancer Controller 测验](./networking/03-aws-lb-controller-quiz.md)
...
- [可观测性优化测验](./observability/09-observability-optimization-quiz.md)
- [Prometheus Alertmanager 测验](./observability/alerting/01-alertmanager-quiz.md)
- [CloudWatch Alarms 测验](./observability/alerting/02-cloudwatch-alarms-quiz.md)
- [Grafana OnCall 测验](./observability/alerting/03-grafana-oncall-quiz.md)
- [Grafana Dashboard 测验](./observability/grafana/grafana-quiz.md)
- [可观测性实验第 1 部分：基础设施设置测验](./observability/labs/01-infrastructure-setup-quiz.md)
- [可观测性实验第 2 部分：可观测性栈测验](./observability/labs/02-observability-stack-quiz.md)
- [可观测性实验第 3 部分：MSA Deployment 和 Canary 测验](./observability/labs/03-msa-deployment-quiz.md)
- [可观测性实验第 4 部分：负载测试和自动扩缩容测验](./observability/labs/04-load-testing-scaling-quiz.md)
- [可观测性实验第 5 部分：告警和 AIOps 测验](./observability/labs/05-alerting-aiops-quiz.md)
- [可观测性实验第 6 部分：分布式追踪分析测验](./observability/labs/06-distributed-tracing-quiz.md)
- [Grafana Loki 测验](./observability/logging/01-loki-quiz.md)
...
- [VictoriaMetrics 测验](./observability/metrics/02-victoriametrics-quiz.md)
- [Grafana Mimir 测验](./observability/metrics/03-mimir-quiz.md)
- [CloudWatch Metrics 测验](./observability/metrics/04-cloudwatch-metrics-quiz.md)
- [Datadog 测验](./observability/metrics/05-datadog-quiz.md)
- [Grafana Tempo 测验](./observability/tracing/01-tempo-quiz.md)
- [AWS X-Ray 测验](./observability/tracing/02-xray-quiz.md)
- [OpenTelemetry 测验](./observability/tracing/03-opentelemetry-quiz.md)
- [Dynatrace 测验](./observability/tracing/04-dynatrace-quiz.md)
...
- [扩缩容策略测验](./ops/06-scaling-strategies-quiz.md)
- [可观测性告警测验](./ops/07-observability-alerts-quiz.md)
- [可观测性分析测验](./ops/08-observability-analysis-quiz.md)
- [可观测性栈测验](./ops/09-observability-stack-quiz.md)
- [资源优化测验](./ops/10-resource-optimization-quiz.md)
- [EKS 升级运维测验](./ops/11-upgrade-operations-quiz.md)
- [事件容量规划测验](./ops/12-event-capacity-planning-quiz.md)
- [FinOps 成本可见性平台测验](./ops/13-finops-cost-platform-quiz.md)
...
- [Backstage IDP 测验](./platform-engineering/06-backstage-idp-quiz.md)
- [Crossplane 测验](./platform-engineering/07-crossplane-quiz.md)
- [vCluster 测验](./platform-engineering/08-vcluster-quiz.md)
...
- [运行时安全测验](./security/08-runtime-security-quiz.md)
- [OPA Gatekeeper 测验](./security/09-opa-gatekeeper-quiz.md)
- [cert-manager 测验](./security/10-cert-manager-quiz.md)
- [Kubescape 测验](./security/11-kubescape-quiz.md)
- [SPIFFE/SPIRE 测验](./security/12-spiffe-spire-quiz.md)

### Service Mesh

- [Istio 测验](./service-mesh/02-istio-quiz.md)
- [Cilium Service Mesh 架构测验](./service-mesh/cilium-service-mesh/architecture.md)
- [Cilium Service Mesh Ingress 和 Gateway 测验](./service-mesh/cilium-service-mesh/ingress-gateway.md)
...
- [流量管理测验](./service-mesh/istio/traffic-management.md)
- [Linkerd 架构测验](./service-mesh/linkerd/architecture.md)
- [Linkerd 安装测验](./service-mesh/linkerd/installation.md)
- [Linkerd 多集群测验](./service-mesh/linkerd/multi-cluster.md)
- [Linkerd 可观测性测验](./service-mesh/linkerd/observability.md)
