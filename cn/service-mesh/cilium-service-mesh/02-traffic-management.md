...
Cilium Service Mesh 中的流量管理结合了基于 eBPF 的 L4 负载均衡与基于 Envoy 的 L7 路由。本章将通过 CiliumEnvoyConfig、CiliumNetworkPolicy 中的 L7 规则以及 Gateway API 集成，讲解高级流量管理功能。
...
CiliumEnvoyConfig 为特定 Service 定义 Envoy 配置：
...
CiliumNetworkPolicy 支持在 L7 层级进行细粒度流量控制：
...
eBPF 驱动的 L4 负载均衡可替代 kube-proxy：
...
- [安全性](./03-security.md): 设置 mTLS 和 L7 网络策略
- [可观测性](./04-observability.md): 使用 Hubble 监控流量
- [Ingress 和 Gateway](./05-ingress-gateway.md): 外部流量管理

## 参考资料

- [Cilium L7 策略文档](https://docs.cilium.io/en/stable/security/policy/language/#layer-7-examples)
- [CiliumEnvoyConfig 参考](https://docs.cilium.io/en/stable/network/servicemesh/envoy-config/)
