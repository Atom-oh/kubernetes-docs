...
本章介绍在生产环境中运行 Cilium Service Mesh 的最佳实践，包括部署检查清单、资源规格确定、性能调优、从 sidecar mesh 迁移、升级策略和故障排查指南。
...
| 规模 | 节点 | Pods | Cilium Agent | Envoy | Hubble Relay |
|------|-------|------|--------------|-------|--------------|
| 小型 | 1-10 | <500 | 500m/512Mi | 200m/256Mi | 100m/128Mi |
| 中型 | 10-50 | 500-2000 | 1000m/1Gi | 500m/512Mi | 200m/256Mi |
| 大型 | 50-200 | 2000-10000 | 2000m/2Gi | 1000m/1Gi | 500m/512Mi |
| 超大型 | 200+ | 10000+ | 4000m/4Gi | 2000m/2Gi | 1000m/1Gi |
...
1. **资源规格确定**：根据集群规模配置 Agent 和 Envoy 资源
2. **安全性**：启用 WireGuard 加密和 mTLS
3. **可观测性**：Hubble 和 Prometheus 指标收集不可或缺
4. **渐进式采用**：分阶段从现有 mesh 迁移
5. **监控**：为核心指标配置告警

### 其他资源

- [Cilium 官方文档](https://docs.cilium.io/)
- [Cilium Slack 社区](https://cilium.herokuapp.com/)
- [Cilium GitHub](https://github.com/cilium/cilium)
- [eBPF 学习资源](https://ebpf.io/)

## 参考资料

- [Cilium 生产指南](https://docs.cilium.io/en/stable/operations/performance/)
- [Cilium 故障排查](https://docs.cilium.io/en/stable/operations/troubleshooting/)
- [Cilium 升级指南](https://docs.cilium.io/en/stable/operations/upgrade/)
- [从 Istio 迁移到 Cilium](https://docs.cilium.io/en/stable/network/servicemesh/istio-migration/)
