...
### EKS Ingress 设置（AWS Load Balancer Controller）
...
### EKS NLB Gateway 设置（Multicluster）
...
- [架构](./02-architecture.md)：深入了解 Linkerd 内部机制
- [流量管理](./03-traffic-management.md)：ServiceProfile 和流量拆分配置
- [安全](./04-security.md)：mTLS 和授权策略设置

## 参考资料

- [Linkerd 安装指南](https://linkerd.io/2/getting-started/)
- [Helm Chart 文档](https://linkerd.io/2/tasks/install-helm/)
- [HA 安装指南](https://linkerd.io/2/features/ha/)
- [EKS 指南](https://linkerd.io/2/reference/cluster-configuration/)
