...
- [最佳实践](./07-best-practices.md): 生产环境多集群设置

## 参考资料

- [Linkerd 多集群](https://linkerd.io/2/features/multicluster/)
- [Service Mirroring](https://linkerd.io/2/tasks/installing-multicluster/)
- [多集群通信](https://linkerd.io/2/tasks/multicluster/)
