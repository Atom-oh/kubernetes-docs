...
> **支持版本**: 所有主流 Linux 发行版 **最后更新**: February 11, 2026

本文档介绍在 Kubernetes 环境中高效工作所需的基本 Linux 运维技能。
...
3. **文本处理**: 解析 kubectl 输出的核心
4. **SSH**: 对节点调试很重要
5. **性能监控**: 故障排查的基础

***

[上一节: Linux 基础](01-linux-basics.md) | [下一节: Container 基础](https://github.com/Atom-oh/kubernetes-docs/blob/main/en/basics/03-container-basics.md)
