...
> **支持的版本**: 所有主要 Linux 发行版 **最后更新**: February 11, 2026

本文档涵盖了在 Kubernetes 环境中有效工作所需的基本 Linux 操作技能。

***

## 目录

1. [环境变量和 Shell 配置](02-linux-advanced.md#1-environment-variables-and-shell-configuration)
...
5. [性能监控和故障排除](02-linux-advanced.md#5-performance-monitoring-and-troubleshooting)
...
1. **环境变量**: Kubernetes ConfigMap/Secret 的基础
2. **Shell 脚本**: Init 容器、健康检查的必要工具
...
[上一步: Linux 基础](01-linux-basics.md) | [下一步: 容器基础](https://github.com/Atom-oh/kubernetes-docs/blob/main/en/basics/03-container-basics.md)
