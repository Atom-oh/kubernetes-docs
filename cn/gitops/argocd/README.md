...
| [应用程序](02-applications.md) | Application CRD、源类型、健康检查、hooks、App of Apps |
| [同步策略](03-sync-strategies.md) | 同步策略、waves、windows、diffing、retry 配置 |
| [ApplicationSets](04-applicationsets.md) | 所有 generators、templating、渐进式同步、多集群模式 |
| [流量管理](05-traffic-management.md) | Argo Rollouts、blue-green、canary、分析、ingress 集成 |
| [Projects 与 RBAC](06-projects-rbac.md) | AppProject、RBAC 策略、多租户、JWT tokens |
| [安全性](07-security.md) | SSO 集成、secret 管理、TLS、审计日志 |
| [通知](08-notifications.md) | 通知服务、triggers、templates、subscriptions |
...
ArgoCD v3.4.5 于 2026 年 7 月 9 日发布。3.4 系列是当前稳定发布系列，下一个次要版本 v3.5.0 已达到 rc2。下表基于 2.x 时代编写——请查看 [ArgoCD 发布页面](https://github.com/argoproj/argo-cd/releases)，获取按版本划分的最新支持信息。
...
3. **[ApplicationSets 指南](04-applicationsets.md)**: 多集群部署
...
要测试所学知识，请尝试 [ArgoCD 安装测验](../../quizzes/gitops/argocd/01-installation-quiz.md)。
