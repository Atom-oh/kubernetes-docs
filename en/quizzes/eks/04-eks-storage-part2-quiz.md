...
3. **Naming Convention**: PVC names are created in the format `<volumeClaimTemplate-name>-<statefulset-name>-<ordinal>`. Example: `data-mysql-0`, `data-mysql-1`, `data-mysql-2`
...
2. **SCRATCH\_2**:
   ...
   * Better availability than SCRATCH\_1
3. **PERSISTENT**:
