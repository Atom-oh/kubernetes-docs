...
8. [Node Lifecycle Management](./eks-hybrid-nodes/07-node-lifecycle.md) | [Quiz](./quizzes/eks-hybrid-nodes/07-node-lifecycle-quiz.md)
...
2. [Expert Networking Path](./networking/expert/README.md)
   - [1. Protocol Projects](./networking/expert/01-protocol-projects.md) | [Quiz](./quizzes/networking/expert/01-protocol-projects-quiz.md)
   - [2. Routing Policy and Convergence](./networking/expert/02-routing-policy-convergence.md) | [Quiz](./quizzes/networking/expert/02-routing-policy-convergence-quiz.md)
   - [3. Data-Center EVPN/VXLAN](./networking/expert/03-datacenter-evpn.md) | [Quiz](./quizzes/networking/expert/03-datacenter-evpn-quiz.md)
   - [4. Linux Packet Paths and Performance](./networking/expert/04-linux-performance.md) | [Quiz](./quizzes/networking/expert/04-linux-performance-quiz.md)
   - [5. Cloud and CNI Design](./networking/expert/05-cloud-cni-design.md) | [Quiz](./quizzes/networking/expert/05-cloud-cni-design-quiz.md)
   - [6. Automation and Final Assessment](./networking/expert/06-automation-capstone.md) | [Quiz](./quizzes/networking/expert/06-automation-capstone-quiz.md)
3. [Kubernetes Networking Overview](./networking/README.md) | [Quiz](./quizzes/networking/00-networking-overview-quiz.md)
4. [Network Fundamentals — 25 Protocols](./basics/06-network-fundamentals-part1.md)
...
5. [Linux Network Diagnostics Practice](./networking/07-linux-network-diagnostics.md) | [Quiz](./quizzes/networking/07-linux-network-diagnostics-quiz.md)
6. [VPC CNI](./networking/01-vpc-cni.md) | [Quiz](./quizzes/networking/01-vpc-cni-quiz.md)
7. **Cilium Deep Dive**
...
9. [VPC Lattice](./networking/02-vpc-lattice.md) | [Quiz](./quizzes/networking/02-vpc-lattice-quiz.md)
10. [AWS Load Balancer Controller](./networking/03-aws-lb-controller.md) | [Quiz](./quizzes/networking/03-aws-lb-controller-quiz.md)
11. [Gateway API](./networking/04-gateway-api.md) | [Quiz](./quizzes/networking/04-gateway-api-quiz.md)
12. [Cross-Org VPC Connectivity](./networking/05-cross-org-vpc-connectivity.md) | [Quiz](./quizzes/networking/05-cross-org-vpc-connectivity-quiz.md)
13. [Pod Network Benchmark](./networking/06-pod-network-benchmark.md) | [Quiz](./quizzes/networking/06-pod-network-benchmark-quiz.md)
