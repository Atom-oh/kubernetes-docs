...
![Grafana Tempo architecture: application traces pass through the OTEL Collector, Distributor and Ingester into S3, the Metrics Generator feeds RED metrics to Grafana, and Grafana TraceQL queries reach S3 and the cache via Query Frontend and Querier.](../../.gitbook/assets/en-observability-tracing-01-tempo-0.png)

[🔍 View interactive diagram](https://www.atomai.click/kubernetes-docs/archmaps/en-observability-tracing-01-tempo-0.html)
