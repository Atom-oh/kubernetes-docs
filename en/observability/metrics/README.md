...
![Diagram comparing the pull model, where a Prometheus server scrapes /metrics endpoints from applications over HTTP GET, against the push model, where applications send metrics via HTTP POST to a central collector such as Datadog or CloudWatch.](../../.gitbook/assets/en-observability-metrics-readme-10.png)

[🔍 View interactive diagram](https://www.atomai.click/kubernetes-docs/archmaps/en-observability-metrics-readme-10.html)
...
![Diagram showing Prometheus, with 15-30 day retention, serving real-time alerts, recent trends, and immediate debugging directly, while forwarding data via remote_write into long-term storage (VictoriaMetrics, Mimir, or Thanos) kept 1+ year for capacity planning, annual trends, compliance, and cost analysis.](../../.gitbook/assets/en-observability-metrics-readme-11.png)

[🔍 View interactive diagram](https://www.atomai.click/kubernetes-docs/archmaps/en-observability-metrics-readme-11.html)
...
![Decision tree for picking a metrics stack: starting from team size and operational capability, it branches on AWS environment for small teams, cost priority for medium teams, and multi-cloud need for large/expert teams, ending at CloudWatch, Datadog, VictoriaMetrics, Amazon Managed Prometheus, or an AMP + Grafana managed setup.](../../.gitbook/assets/en-observability-metrics-readme-12.png)

[🔍 View interactive diagram](https://www.atomai.click/kubernetes-docs/archmaps/en-observability-metrics-readme-12.html)

## Metrics Collection Architecture

### Kubernetes Environment Metrics Collection Structure

![Diagram showing node-exporter, kube-state-metrics, cAdvisor, and application /metrics endpoints scraped by Prometheus or vmagent, which writes to short-term Prometheus TSDB and via remote_write to long-term VictoriaMetrics; both feed Grafana, and TSDB feeds Alertmanager.](../../.gitbook/assets/en-observability-metrics-readme-13.png)

[🔍 View interactive diagram](https://www.atomai.click/kubernetes-docs/archmaps/en-observability-metrics-readme-13.html)
