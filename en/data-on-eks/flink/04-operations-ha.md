...
![Two-loop interaction: the Flink autoscaler sets operator parallelism from vertex metrics; when TaskManager pods are requested, Karpenter provisions a new EC2 node, and when pods are removed and a node goes empty, Karpenter consolidates and terminates it.](../../.gitbook/assets/en-data-on-eks-flink-04-operations-ha-0.png)

[🔍 View interactive diagram](https://www.atomai.click/kubernetes-docs/archmaps/en-data-on-eks-flink-04-operations-ha-0.html)
