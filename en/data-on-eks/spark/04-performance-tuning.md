...
![Two-loop cycle diagram: Spark DRA sees pending tasks and requests executor pods, Karpenter provisions an EC2 node for Pending pods, then once tasks drain DRA releases idle executors, the node empties and Karpenter reclaims it, restarting the loop.](../../.gitbook/assets/en-data-on-eks-spark-04-performance-tuning-0.png)

[🔍 View interactive diagram](https://www.atomai.click/kubernetes-docs/archmaps/en-data-on-eks-spark-04-performance-tuning-0.html)
