...
* [Expert Networking Path](networking/expert/README.md)
  * [1. Protocol Projects](networking/expert/01-protocol-projects.md)
  * [2. Routing Policy and Convergence](networking/expert/02-routing-policy-convergence.md)
  * [3. Data-Center EVPN/VXLAN](networking/expert/03-datacenter-evpn.md)
  * [4. Linux Packet Paths and Performance](networking/expert/04-linux-performance.md)
  * [5. Cloud and CNI Design](networking/expert/05-cloud-cni-design.md)
  * [6. Automation and Final Assessment](networking/expert/06-automation-capstone.md)
...
* [LLM Gateway (Inference Gateway) Deep Dive](ai-ml/08-llm-gateway.md)
...
* [SageMaker AI Qwen PII Guidebook](ai-ml/sagemaker-ai/README.md)
  * [Workshop: synthetic data and augmentation](ai-ml/sagemaker-ai/06-data-augmentation-workshop.md)
  * [Workshop: QLoRA training and SageMaker](ai-ml/sagemaker-ai/05-qlora-finetuning-workshop.md)
  * [Workshop: PII evaluation and redaction](ai-ml/sagemaker-ai/07-pii-evaluation-release.md)
...
* AI/ML
  ...
  * [LLM Gateway Quiz](quizzes/ai-ml/08-llm-gateway-quiz.md)
  * [Part 1: Ray Architecture Quiz](quizzes/ai-ml/ray/01-architecture-quiz.md)
  * [Part 2: KubeRay Operator Quiz](quizzes/ai-ml/ray/02-kuberay-operator-quiz.md)
  * [Part 3: Ray Train and Tune Quiz](quizzes/ai-ml/ray/03-ray-train-tune-quiz.md)
  * [Part 4: Ray Serve Quiz](quizzes/ai-ml/ray/04-ray-serve-quiz.md)
  * [Part 1: Kubeflow Architecture and Installation Quiz](quizzes/ai-ml/kubeflow/01-architecture-installation-quiz.md)
  * [Part 2: Kubeflow Pipelines Quiz](quizzes/ai-ml/kubeflow/02-pipelines-quiz.md)
  * [Part 3: Kubeflow Notebooks Quiz](quizzes/ai-ml/kubeflow/03-notebooks-quiz.md)
  ...
  * [SageMaker QLoRA Workshop Quiz](quizzes/ai-ml/sagemaker-ai/05-qlora-finetuning-workshop-quiz.md)
  * [SageMaker Data Augmentation Workshop Quiz](quizzes/ai-ml/sagemaker-ai/06-data-augmentation-workshop-quiz.md)
  * [SageMaker PII Evaluation Workshop Quiz](quizzes/ai-ml/sagemaker-ai/07-pii-evaluation-release-quiz.md)
...
* Networking
  ...
  * Expert Networking Path
    * [Protocol Projects Quiz](quizzes/networking/expert/01-protocol-projects-quiz.md)
    * [Routing Policy and Convergence Quiz](quizzes/networking/expert/02-routing-policy-convergence-quiz.md)
    * [Data-Center EVPN/VXLAN Quiz](quizzes/networking/expert/03-datacenter-evpn-quiz.md)
    * [Linux Packet Paths and Performance Quiz](quizzes/networking/expert/04-linux-performance-quiz.md)
    * [Cloud and CNI Design Quiz](quizzes/networking/expert/05-cloud-cni-design-quiz.md)
    * [Automation and Final Assessment Quiz](quizzes/networking/expert/06-automation-capstone-quiz.md)
