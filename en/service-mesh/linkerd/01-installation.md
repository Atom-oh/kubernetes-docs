...
This document covers various methods for installing Linkerd in your Kubernetes cluster. It comprehensively explains CLI tool installation, control plane installation, High Availability (HA) configuration, and extension installations including Viz, Jaeger, and Multicluster.

## Prerequisites

### Kubernetes Version

| Linkerd Version | Minimum Kubernetes Version | Recommended Kubernetes Version |
|-----------------|---------------------------|-------------------------------|
| 2.16.x | 1.25+ | 1.28+ |
| 2.15.x | 1.24+ | 1.27+ |
| 2.14.x | 1.22+ | 1.26+ |
...
- TCP port 443: Webhook communication
- TCP port 8443: Proxy injector
- TCP port 8089: Tap API
...
### Preview Installation Manifests
...
Helm enables more fine-grained configuration.
...
Certificates must be provided when installing with Helm.
...
High availability configuration is recommended for production environments.

### HA Installation Using CLI
...
The Viz extension provides Linkerd's observability features.
...
## Amazon EKS-Specific Configuration
...
### EKS CNI Compatibility

Linkerd is compatible with most CNIs.
...
### EKS Ingress Setup (AWS Load Balancer Controller)
...
### EKS NLB Gateway Setup (Multicluster)
...
### Data Plane Upgrade (Proxy Rolling Restart)
...
- [Architecture](./02-architecture.md): Detailed understanding of Linkerd internals
- [Traffic Management](./03-traffic-management.md): ServiceProfile and traffic splitting configuration
- [Security](./04-security.md): mTLS and authorization policy setup

## References

- [Linkerd Installation Guide](https://linkerd.io/2/getting-started/)
- [Helm Chart Documentation](https://linkerd.io/2/tasks/install-helm/)
- [HA Installation Guide](https://linkerd.io/2/features/ha/)
- [EKS Guide](https://linkerd.io/2/reference/cluster-configuration/)
