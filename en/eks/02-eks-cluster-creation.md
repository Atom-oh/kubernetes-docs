...
spec:
  template:
    ...
    spec:
      ...
      nodeClassRef:
        # EKS Auto Mode: reference eks.amazonaws.com/NodeClass (built-in "default"),
        # not karpenter.k8s.aws/EC2NodeClass. The AMI, bootstrap (userData) and
        # node OS are managed by Auto Mode, so they are not specified here.
