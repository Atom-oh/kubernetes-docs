# EKS Networking - Part 3: Performance Optimization, Troubleshooting, Advanced Use Cases
...
1. **Pod IP Assignment Failure**:
   ...
   - Solution:
     ...
     - Increase WARM_IP_TARGET: `kubectl set env daemonset aws-node -n kube-system WARM_IP_TARGET=10`
