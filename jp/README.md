...
# Kubernetes と Amazon EKS トレーニングコンテンツ
[![GitBook](https://img.shields.io/static/v1?message=Documented%20on%20GitBook&logo=gitbook&logoColor=ffffff&label=%20&labelColor=5c5c5c&color=3F89A1)](https://www.gitbook.com/preview?utm_source=gitbook_readme_badge&utm_medium=organic&utm_campaign=preview_documentation&utm_content=link)

このリポジトリは、Linux とコンテナの基礎、Kubernetes と Amazon EKS、ネットワーキング、サービスメッシュ、ストレージ、データベース、データパイプライン、AI/ML、セキュリティと運用を網羅する包括的なクラウドガイドブックです。学習資料に加え、実際の AWS 環境で計測したベンチマークデータ、トピック別クイズ、厳選したハンズオンラボを提供します。

## 学習資料とクイズ

このトレーニングコンテンツでは、各トピックの学習資料とともにクイズを提供します。クイズを通じて、学んだ内容を確認し定着させることができます。各クイズは回答を非表示にするトグル形式で設計されているため、回答を表示する前にまず問題に取り組めます。

- [学習資料の目次](#table-of-contents) - トピック別の学習資料
- [クイズコレクション](./quizzes/README.md) - トピック別のクイズ
- [ガイドブックロードマップ](./roadmap.md) - 学習マップ全体と推奨学習パス | [クイズ](./quizzes/roadmap-quiz.md)
- [LLM で読む](./llm-guide.md) - llms.txt、マニフェスト、MCP を通じたソース資料の検索と閲覧 | [クイズ](./quizzes/llm-guide-quiz.md)

## 目次

### ニュース
- [週間ニュース](./news/README.md) - Kubernetes/EKS エコシステムの最新ニュースダイジェスト
...
3. [カーネルネットワーキングスタック](./kernel/02-network-stack.md) | [クイズ](./quizzes/kernel/02-network-stack-quiz.md)
...
2. [クラスタアーキテクチャ](./core/01-cluster-architecture.md) | [クイズ](./quizzes/core/01-cluster-architecture-quiz.md)
...
10. [クラスタ管理](./core/09-cluster-administration.md) | [クイズ](./quizzes/core/09-cluster-administration-quiz.md)
...
13. カスタムスケジューラ
   - [パート 1: カスタムスケジューラの基礎](./scheduling/01-custom-scheduler-part1.md) | [クイズ](./quizzes/scheduling/02-custom-scheduler-part1-quiz.md)
   ...
   - [パート 3: カスタムスケジューラの実装例と監視](./scheduling/03-custom-scheduler-part3.md) | [クイズ](./quizzes/scheduling/02-custom-scheduler-part3-quiz.md)
14. オートスケーリング
...
2. EKS クラスタの作成
   ...
   - [パート 2: eksctl によるクラスタの作成](./eks/02-eks-cluster-creation-part2.md) | [クイズ](./quizzes/eks/02-eks-cluster-creation-part2-quiz.md)
   - [パート 3: AWS Management Console と CLI によるクラスタの作成](./eks/02-eks-cluster-creation-part3.md) | [クイズ](./quizzes/eks/02-eks-cluster-creation-part3-quiz.md)
   - [パート 4: Terraform と CDK によるクラスタの作成](./eks/02-eks-cluster-creation-part4.md) | [クイズ](./quizzes/eks/02-eks-cluster-creation-part4-quiz.md)
   - [パート 5: クラスタアクセス、検証、アップグレード、削除](./eks/02-eks-cluster-creation-part5.md) | [クイズ](./quizzes/eks/02-eks-cluster-creation-part5-quiz.md)
3. EKS ネットワーキング
...
4. EKS ストレージ
   ...
   - [パート 3: 監視、トラブルシューティング、コスト最適化、セキュリティ](./eks/04-eks-storage-part3.md) | [クイズ](./quizzes/eks/04-eks-storage-part3-quiz.md)
...
5. [Node ブートストラップ](./eks-hybrid-nodes/04-node-bootstrap.md) | [クイズ](./quizzes/eks-hybrid-nodes/04-node-bootstrap-quiz.md)
...
2. [開始方法](./eks-auto-mode/01-getting-started.md) | [クイズ](./quizzes/eks-auto-mode/01-getting-started-quiz.md)
...
2. [ネットワークの基礎 — 25 のプロトコル](./basics/06-network-fundamentals-part1.md)
   - [パート 1: レイヤーモデル、リンク層、ルーティング層](./basics/06-network-fundamentals-part1.md) | [クイズ](./quizzes/basics/06-network-fundamentals-part1-quiz.md)
...
3. [VPC CNI](./networking/01-vpc-cni.md) | [クイズ](./quizzes/networking/01-vpc-cni-quiz.md)
4. **Cilium 詳細解説**
...
5. **Calico 詳細解説**
   ...
   - [パート 6: eBPF データプレーン](./networking/calico/06-ebpf-dataplane.md) | [クイズ](./quizzes/networking/calico/06-ebpf-dataplane-quiz.md)
...
6. [VPC Lattice](./networking/02-vpc-lattice.md) | [クイズ](./quizzes/networking/02-vpc-lattice-quiz.md)
7. [AWS Load Balancer Controller](./networking/03-aws-lb-controller.md) | [クイズ](./quizzes/networking/03-aws-lb-controller-quiz.md)
8. [Gateway API](./networking/04-gateway-api.md) | [クイズ](./quizzes/networking/04-gateway-api-quiz.md)
9. [組織横断 VPC 接続](./networking/05-cross-org-vpc-connectivity.md) | [クイズ](./quizzes/networking/05-cross-org-vpc-connectivity-quiz.md)
10. [Pod ネットワークベンチマーク](./networking/06-pod-network-benchmark.md) | [クイズ](./quizzes/networking/06-pod-network-benchmark-quiz.md)
...
2. **Linkerd**
   ...
   - [マルチクラスタ](./service-mesh/linkerd/06-multi-cluster.md) | [クイズ](./quizzes/service-mesh/linkerd/multi-cluster.md)
...
4. **VPC Lattice 詳細解説**
   - [VPC Lattice 詳細解説の概要](./service-mesh/vpc-lattice/README.md)
...
2. [EBS gp2 と gp3 の計測ベンチマーク](./storage/01-ebs-gp2-gp3-benchmark.md) | [クイズ](./quizzes/storage/01-ebs-gp2-gp3-benchmark-quiz.md)

### データベース
1. [Kubernetes 上のデータベースの概要](./database/README.md)
2. [EKS 上の ClickHouse 計測ベンチマーク](./database/01-clickhouse-on-eks.md) | [クイズ](./quizzes/database/01-clickhouse-on-eks-quiz.md)
...
3. [EKS 上でのブロックチェーン Node の実行](./blockchain/02-nodes-on-eks.md) | [クイズ](./quizzes/blockchain/02-nodes-on-eks-quiz.md)
...
1. [EKS 上のデータの概要](./data-on-eks/README.md)
   - [モダンデータパイプラインの構造](./data-on-eks/01-data-pipeline-anatomy.md) | [クイズ](./quizzes/data-on-eks/01-data-pipeline-anatomy-quiz.md)
   - [SageMaker Unified Studio ガバナンス](./data-on-eks/sagemaker-unified-studio/README.md)
...
2. **EKS 上の Kafka 詳細解説**
   ...
   - [パート 9: Kafka 計測ベンチマーク](./data-on-eks/kafka/09-kafka-benchmark.md) | [クイズ](./quizzes/data-on-eks/kafka/09-kafka-benchmark-quiz.md)
3. **EKS 上の Spark 詳細解説**
...
8. **EKS 上の Ray 詳細解説**
   - [EKS 上の Ray 入門](./ai-ml/ray/README.md)
...
12. [LLM Gateway (Inference Gateway) 詳細解説](./ai-ml/08-llm-gateway.md) | [クイズ](./quizzes/ai-ml/08-llm-gateway-quiz.md)
...
4. [マルチアカウント、マルチクラスタ EKS アーキテクチャ](./governance/03-eks-multi-account-multi-cluster.md) | [クイズ](./quizzes/governance/03-eks-multi-account-multi-cluster-quiz.md)
...
4. [GitOps マルチクラスタ](./ops/04-gitops-multi-cluster.md) | [クイズ](./quizzes/ops/04-gitops-multi-cluster-quiz.md)
...
12. [イベントキャパシティ計画プレイブック](./ops/12-event-capacity-planning.md) | [クイズ](./quizzes/ops/12-event-capacity-planning-quiz.md)
...
15. [ゾーンクラスタ運用](./ops/15-zonal-operations-guide.md) | [クイズ](./quizzes/ops/15-zonal-operations-guide-quiz.md)
16. [トラブルシューティングプレイブック](./ops/16-troubleshooting-playbook.md) | [クイズ](./quizzes/ops/16-troubleshooting-playbook-quiz.md)
17. [EKS Spot 本番実験と結果評価](./ops/17-spot-production-experiments.md) | [クイズ](./quizzes/ops/17-spot-production-experiments-quiz.md)

## ラボガイド

理論を学んだ後に実際の環境で練習できるハンズオンラボガイドを提供します。

- [ラボガイド一覧](./labs/README.md)
- 基礎: Linux の基礎、Linux 運用、コンテナラボ
