...
このリポジトリは、Linux とコンテナの基礎、Kubernetes と Amazon EKS、ネットワーキング、サービスメッシュ、ストレージ、データベース、データパイプライン、AI/ML、セキュリティと運用を網羅する包括的なクラウドガイドブックです。学習教材に加え、実際の AWS 環境で計測したベンチマークデータ、および各トピックのクイズとハンズオンラボを提供します。

## 学習教材とクイズ

このトレーニングコンテンツでは、各トピックの学習教材とともにクイズを提供しています。クイズを通じて、学んだ内容をテストし、定着させることができます。各クイズは回答が非表示のトグル形式で設計されているため、回答を表示する前にまず問題に取り組めます。

- [学習教材の目次](#table-of-contents) - トピック別の学習教材
- [クイズ集](./quizzes/README.md) - トピック別のクイズ
- [ガイドブックのロードマップ](./roadmap.md) - 学習マップ全体と推奨学習パス | [クイズ](./quizzes/roadmap-quiz.md)
- [LLM で読む](./llm-guide.md) - llms.txt を通じてこのガイドブック全体を AI に読み込ませる方法 | [クイズ](./quizzes/llm-guide-quiz.md)

## 目次

### ニュース
- [週刊ニュース](./news/README.md) - 最新の Kubernetes/EKS エコシステムニュースのダイジェスト
...
9. [スケジューリング、プリエンプション、エビクション](./core/08-scheduling-preemption-eviction.md) | [クイズ](./quizzes/core/08-scheduling-preemption-eviction-quiz.md)
...
3. EKS ネットワーキング
   - [パート 1: 基本コンセプトと VPC 設定](./eks/03-eks-networking-part1.md) | [クイズ](./quizzes/eks/03-eks-networking-part1-quiz.md)
...
4. EKS ストレージ
   - [パート 1: 基本コンセプト、EBS、EFS](./eks/04-eks-storage-part1.md) | [クイズ](./quizzes/eks/04-eks-storage-part1-quiz.md)
...
5. [Node のブートストラップ](./eks-hybrid-nodes/04-node-bootstrap.md) | [クイズ](./quizzes/eks-hybrid-nodes/04-node-bootstrap-quiz.md)
...
4. **Cilium 詳細解説**
   ...
   - [パート 6: セキュリティと可観測性](./networking/cilium/06-security-visibility.md) | [クイズ](./quizzes/networking/cilium/06-security-visibility-quiz.md)
   - [パート 7: 高度なトピック](./networking/cilium/07-advanced-topics.md) | [クイズ](./quizzes/networking/cilium/07-advanced-topics-quiz.md)
   - [ネットワーキングのコンセプト](./networking/cilium/networking-concepts.md) | [クイズ](./quizzes/networking/cilium/networking-concepts-quiz.md)
...
2. **EKS 上の Kafka 詳細解説**
   ...
   - [パート 9: Kafka の計測ベンチマーク](./data-on-eks/kafka/09-kafka-benchmark.md) | [クイズ](./quizzes/data-on-eks/kafka/09-kafka-benchmark-quiz.md)
3. **EKS 上の Spark 詳細解説**
...
4. **EKS 上の Airflow 詳細解説**
   ...
   - [パート 2: Helm による Deployment と Executor の選択](./data-on-eks/airflow/02-helm-deployment.md) | [クイズ](./quizzes/data-on-eks/airflow/02-helm-deployment-quiz.md)
...
5. [vLLM の Deployment と最適化](./ai-ml/02-vllm-deployment.md) | [クイズ](./quizzes/ai-ml/04-vllm-deployment-quiz.md)
...
10. **EKS 上の MLflow 詳細解説**
   ...
   - [パート 3: EKS への MLflow の Deployment](./ai-ml/mlflow/03-eks-deployment.md) | [クイズ](./quizzes/ai-ml/mlflow/03-eks-deployment-quiz.md)
11. **SageMaker AI Qwen PII ガイドブック**
   ...
   - [パート 4: Unified Studio のガバナンス](./data-on-eks/sagemaker-unified-studio/01-domains-projects-governance.md) | [クイズ](./quizzes/data-on-eks/sagemaker-unified-studio/01-domains-projects-governance-quiz.md)
...
2. [インフラストラクチャの高度な設定](./ops/02-infrastructure-advanced.md) | [クイズ](./quizzes/ops/02-infrastructure-advanced-quiz.md)
...
8. [可観測性の分析](./ops/08-observability-analysis.md) | [クイズ](./quizzes/ops/08-observability-analysis-quiz.md)
...
12. [イベント容量計画プレイブック](./ops/12-event-capacity-planning.md) | [クイズ](./quizzes/ops/12-event-capacity-planning-quiz.md)
...
15. [ゾーンクラスター運用](./ops/15-zonal-operations-guide.md) | [クイズ](./quizzes/ops/15-zonal-operations-quiz.md)
16. [トラブルシューティングプレイブック](./ops/16-troubleshooting-playbook.md) | [クイズ](./quizzes/ops/16-troubleshooting-playbook-quiz.md)

## ラボガイド

理論を学んだ後に実際の環境で練習できるハンズオンラボガイドを提供しています。
...
4. [パート 3: MSA の Deployment と Canary](./labs/observability/03-msa-deployment-lab.md) | [クイズ](./quizzes/observability/labs/03-msa-deployment-quiz.md)
