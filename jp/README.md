...
# Kubernetes と Amazon EKS 学習コンテンツ
[![GitBook](https://img.shields.io/static/v1?message=Documented%20on%20GitBook&logo=gitbook&logoColor=ffffff&label=%20&labelColor=5c5c5c&color=3F89A1)](https://www.gitbook.com/preview?utm_source=gitbook_readme_badge&utm_medium=organic&utm_campaign=preview_documentation&utm_content=link)

このリポジトリは、Linux とコンテナの基礎、Kubernetes と Amazon EKS、ネットワーキング、Service Mesh、ストレージ、データベース、データパイプライン、AI/ML、セキュリティと運用までを扱う包括的なクラウドガイドブックです。学習資料に加えて、実際の AWS 環境で計測したベンチマークデータ、トピック別クイズ、厳選したハンズオンラボを提供します。

## 学習資料とクイズ

この学習コンテンツでは、学習資料とともにトピックごとのクイズを提供します。クイズを通じて学んだ内容を確認し、定着させることができます。各クイズは解答が隠されたトグル形式になっており、先に自分で解いてから解答を確認できます。

- [学習資料目次](#table-of-contents) - トピック別の学習資料
- [クイズ集](./quizzes/README.md) - トピック別のクイズ
- [ガイドブックロードマップ](./roadmap.md) - 学習マップ全体と推奨学習パス | [クイズ](./quizzes/roadmap-quiz.md)
- [LLM で読む](./llm-guide.md) - llms.txt、マニフェスト、MCP を通じて原典資料を探して読む | [クイズ](./quizzes/llm-guide-quiz.md)

## 目次

### ニュース
- [ウィークリーニュース](./news/README.md) - 最新の Kubernetes/EKS エコシステムニュースダイジェスト
...
2. EKS クラスターの作成
   - [Part 1: 事前準備](./eks/02-eks-cluster-creation-part1.md) | [クイズ](./quizzes/eks/02-eks-cluster-creation-part1-quiz.md)
...
10. [EKS の耐障害性と高可用性](./eks/10-eks-resiliency.md) | [クイズ](./quizzes/eks/10-eks-resiliency-quiz.md)
11. [EKS の高度なデバッグ](./eks/11-eks-advanced-debugging.md) | [クイズ](./quizzes/eks/11-eks-advanced-debugging-quiz.md)
12. [Kubernetes バージョンごとの機能とロードマップ](./eks/12-kubernetes-version-roadmap.md) | [クイズ](./quizzes/eks/12-kubernetes-version-roadmap-quiz.md)

### EKS Hybrid Nodes
1. [EKS Hybrid Nodes 入門](./eks-hybrid-nodes/README.md)
2. [事前準備](./eks-hybrid-nodes/01-prerequisites.md) | [クイズ](./quizzes/eks-hybrid-nodes/01-prerequisites-quiz.md)
3. [ネットワーク構成](./eks-hybrid-nodes/02-network-configuration.md) | [クイズ](./quizzes/eks-hybrid-nodes/02-network-configuration-quiz.md)
4. [エアギャップ環境の構築](./eks-hybrid-nodes/03-airgap-setup.md) | [クイズ](./quizzes/eks-hybrid-nodes/03-airgap-setup-quiz.md)
...
9. [運用とメンテナンス](./eks-hybrid-nodes/08-operations.md) | [クイズ](./quizzes/eks-hybrid-nodes/08-operations-quiz.md)
10. [ベアメタル OS の構築](./eks-hybrid-nodes/09-bare-metal-os-setup.md) | [クイズ](./quizzes/eks-hybrid-nodes/09-bare-metal-os-setup-quiz.md)
...
3. [NodePool の設定](./eks-auto-mode/02-nodepool-configuration.md) | [クイズ](./quizzes/eks-auto-mode/02-nodepool-configuration-quiz.md)
...
1. [ゼロから学ぶ Linux ネットワーキング](./networking/beginner/README.md)
   ...
   - [2. アドレスとインターフェイス](./networking/beginner/02-addressing-interfaces.md) | [クイズ](./quizzes/networking/beginner/02-addressing-interfaces-quiz.md)
   - [3. 永続的なネットワーク設定](./networking/beginner/03-persistent-configuration.md) | [クイズ](./quizzes/networking/beginner/03-persistent-configuration-quiz.md)
   ...
   - [8. 総合演習とクラウド接続](./networking/beginner/08-container-cloud-capstone.md) | [クイズ](./quizzes/networking/beginner/08-container-cloud-capstone-quiz.md)
2. [エキスパートネットワーキングパス](./networking/expert/README.md)
   ...
   - [6. 自動化と最終評価](./networking/expert/06-automation-capstone.md) | [クイズ](./quizzes/networking/expert/06-automation-capstone-quiz.md)
...
4. [ネットワークの基礎 — 25 のプロトコル](./basics/06-network-fundamentals-part1.md)
   - [Part 1: レイヤーモデル、リンク層とルーティング層](./basics/06-network-fundamentals-part1.md) | [クイズ](./quizzes/basics/06-network-fundamentals-part1-quiz.md)
...
7. **Cilium ディープダイブ**
   ...
   - [Part 1: はじめに](./networking/cilium/01-introduction.md) | [クイズ](./quizzes/networking/cilium/01-introduction-quiz.md)
   ...
   - [Part 7: 応用トピック](./networking/cilium/07-advanced-topics.md) | [クイズ](./quizzes/networking/cilium/07-advanced-topics-quiz.md)
...
8. **Calico ディープダイブ**
   ...
   - [Part 1: はじめに](./networking/calico/01-introduction.md) | [クイズ](./quizzes/networking/calico/01-introduction-quiz.md)
   ...
   - [Part 7: 応用トピック](./networking/calico/07-advanced-topics.md) | [クイズ](./quizzes/networking/calico/07-advanced-topics-quiz.md)
...
12. [組織をまたぐ VPC 接続](./networking/05-cross-org-vpc-connectivity.md) | [クイズ](./quizzes/networking/05-cross-org-vpc-connectivity-quiz.md)
...
4. **VPC Lattice ディープダイブ**
   ...
   - [制約と意思決定ポイント](./service-mesh/vpc-lattice/06-constraints.md) | [クイズ](./quizzes/service-mesh/vpc-lattice/06-constraints-quiz.md)
...
3. [EKS 上でのブロックチェーンノード運用](./blockchain/02-nodes-on-eks.md) | [クイズ](./quizzes/blockchain/02-nodes-on-eks-quiz.md)
...
4. **Airflow on EKS ディープダイブ**
   ...
   - [Part 3: DAG パターンと KubernetesPodOperator](./data-on-eks/airflow/03-dag-patterns.md) | [クイズ](./quizzes/data-on-eks/airflow/03-dag-patterns-quiz.md)
...
9. **Kubeflow on EKS ディープダイブ**
   ...
   - [Part 6: KServe — Kubernetes 上のモデルサービング](./ai-ml/kubeflow/06-kserve.md) | [クイズ](./quizzes/ai-ml/kubeflow/06-kserve-quiz.md)
...
11. **SageMaker AI Qwen PII ガイドブック**
   ...
   - [Part 2: 合成 PII データとトークナイゼーション](./ai-ml/sagemaker-ai/02-pii-data-tokenization.md) | [クイズ](./quizzes/ai-ml/sagemaker-ai/02-pii-data-tokenization-quiz.md)
...
5. [Secret 管理](./security/05-secrets-management.md) | [クイズ](./quizzes/security/05-secrets-management-quiz.md)
...
2. **ArgoCD**
   ...
   - [Rollouts Experiments ディープダイブ](./gitops/argocd/10-rollouts-experiment.md) | [クイズ](./quizzes/gitops/argocd/10-rollouts-experiment-quiz.md)
...
2. [Landing Zone、OU、組織的統制](./governance/01-landing-zone-and-ou.md) | [クイズ](./quizzes/governance/01-landing-zone-and-ou-quiz.md)
...
5. [Shared VPC と接続性](./governance/04-shared-vpc-and-connectivity.md) | [クイズ](./quizzes/governance/04-shared-vpc-and-connectivity-quiz.md)
...
17. [EKS Spot 本番環境での実験と結果評価](./ops/17-spot-production-experiments.md) | [クイズ](./quizzes/ops/17-spot-production-experiments-quiz.md)

## ラボガイド

理論を学んだ後に実環境で練習できるハンズオンラボガイドを提供します。

- [ラボガイド一覧](./labs/README.md)
- 基礎: Linux の基礎、Linux 運用、コンテナのラボ
- コア: Pod、Service、ストレージ、ConfigMap のラボ
- EKS: クラスター作成のラボ
...
2. 各章を読み終えたら、対応するクイズを解いて理解度を確認します
3. 練習環境でコマンドやサンプルコードを実際に実行します

### 上級者向けの学習パス
1. 次の順序で学習します: **Amazon EKS** -> **AI/ML** -> **Service Mesh** -> **セキュリティとポリシー**
2. **Cilium** セクションでネットワーキングを深く掘り下げます
3. 特定のツールや技術に絞って集中的に学習します

### クイズの活用方法
- 各ドキュメントの末尾にあるクイズリンクをクリックして学習内容を確認します
- トグル形式の解答を開く前に、まず自分で考えます
- 間違えた問題は対応するドキュメントで復習します
