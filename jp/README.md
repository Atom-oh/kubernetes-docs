...
このリポジトリは、Linux とコンテナの基礎、Kubernetes と Amazon EKS、ネットワーキング、Service Mesh、ストレージ、データベース、データパイプライン、AI/ML、セキュリティと運用までを網羅した総合的なクラウドガイドブックです。学習教材に加えて、実際の AWS 環境で計測したベンチマークデータ、トピック別クイズ、厳選したハンズオンラボも提供します。

## 学習教材とクイズ

この学習コンテンツでは、学習教材とあわせてトピックごとのクイズを提供します。クイズを通じて学んだ内容を確認し、定着させることができます。各クイズは解答が隠されたトグル形式になっているため、まず自分で解答を考えてから答えを確認できます。

- [学習教材の目次](#table-of-contents) - トピック別の学習教材
- [クイズ集](./quizzes/README.md) - トピック別のクイズ
- [ガイドブックロードマップ](./roadmap.md) - 全体の学習マップと推奨学習パス | [クイズ](./quizzes/roadmap-quiz.md)
- [LLM を使った読み方](./llm-guide.md) - llms.txt、マニフェスト、MCP を通じて原典を探して読む | [クイズ](./quizzes/llm-guide-quiz.md)
...
3. [カーネルのネットワークスタック](./kernel/02-network-stack.md) | [クイズ](./quizzes/kernel/02-network-stack-quiz.md)
...
9. [スケジューリング、プリエンプション、退避](./core/08-scheduling-preemption-eviction.md) | [クイズ](./quizzes/core/08-scheduling-preemption-eviction-quiz.md) | [ラボ](./labs/core/08-scheduling-preemption-eviction-lab.md)
...
5. [EKS のセキュリティ](./eks/05-eks-security.md) | [クイズ](./quizzes/eks/05-eks-security-quiz.md)
...
5. [Spot インスタンス戦略](./eks-auto-mode/04-spot-strategies.md) | [クイズ](./quizzes/eks-auto-mode/04-spot-strategies-quiz.md)
...
2. [エキスパート向けネットワーキングパス](./networking/expert/README.md)
   - [1. プロトコルのプロジェクト](./networking/expert/01-protocol-projects.md) | [クイズ](./quizzes/networking/expert/01-protocol-projects-quiz.md)
...
7. **Cilium ディープダイブ**
   ...
   - [Part 1: 入門](./networking/cilium/01-introduction.md) | [クイズ](./quizzes/networking/cilium/01-introduction-quiz.md)
   ...
   - [Part 6: セキュリティと可視性](./networking/cilium/06-security-visibility.md) | [クイズ](./quizzes/networking/cilium/06-security-visibility-quiz.md)
...
8. **Calico ディープダイブ**
   ...
   - [Part 1: 入門](./networking/calico/01-introduction.md) | [クイズ](./quizzes/networking/calico/01-introduction-quiz.md)
...
13. [Pod ネットワークのベンチマーク](./networking/06-pod-network-benchmark.md) | [クイズ](./quizzes/networking/06-pod-network-benchmark-quiz.md)
...
3. [EKS でのブロックチェーンノードの実行](./blockchain/02-nodes-on-eks.md) | [クイズ](./quizzes/blockchain/02-nodes-on-eks-quiz.md)
...
1. [Data on EKS 概要](./data-on-eks/README.md)
   - [モダンなデータパイプラインの構造](./data-on-eks/01-data-pipeline-anatomy.md) | [クイズ](./quizzes/data-on-eks/01-data-pipeline-anatomy-quiz.md)
...
3. [EKS でのモデルトレーニング](./ai-ml/05-model-training.md) | [クイズ](./quizzes/ai-ml/05-model-training-quiz.md)
...
9. **Kubeflow on EKS ディープダイブ**
   ...
   - [Part 5: Kubeflow Trainer と分散トレーニング](./ai-ml/kubeflow/05-training-operator.md) | [クイズ](./quizzes/ai-ml/kubeflow/05-training-operator-quiz.md)
   - [Part 6: KServe — Kubernetes でのモデルサービング](./ai-ml/kubeflow/06-kserve.md) | [クイズ](./quizzes/ai-ml/kubeflow/06-kserve-quiz.md)
...
2. [Landing Zone、OU、組織的な統制](./governance/01-landing-zone-and-ou.md) | [クイズ](./quizzes/governance/01-landing-zone-and-ou-quiz.md)
...
5. [ExampleCorp: ACK + KRO の統合例](./platform-engineering/05-example-corp-app.md)
...
12. [イベントのキャパシティプランニング Playbook](./ops/12-event-capacity-planning.md) | [クイズ](./quizzes/ops/12-event-capacity-planning-quiz.md)
...
17. [EKS Spot の本番環境における実験と結果評価](./ops/17-spot-production-experiments.md) | [クイズ](./quizzes/ops/17-spot-production-experiments-quiz.md)
...
2. **Cilium** のセクションでネットワーキングを深く掘り下げます
3. 特定のツールや技術に集中して深く学習します

### クイズの活用方法
- 各ドキュメントの末尾にあるクイズのリンクをクリックして学習内容を確認します
- トグル形式の解答は、開く前にまず自分で考えます
- 間違えた問題については、対応するドキュメントを復習します
