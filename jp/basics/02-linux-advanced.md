...
> **対応バージョン**: 主要なすべての Linux ディストリビューション **最終更新**: February 11, 2026
...
2. [Shell Scripting の基礎](02-linux-advanced.md#2-shell-scripting-basics)
...
6. [Storage 管理の基礎](02-linux-advanced.md#6-storage-management-basics)
7. [curl と API 呼び出し](02-linux-advanced.md#7-curl-and-api-calls)
8. [実用的な One-Liner 集](02-linux-advanced.md#8-practical-one-liners-collection)
...
2. **Shell Scripting**: Init Container や health check に不可欠
