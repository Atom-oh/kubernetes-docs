...
**ステップ 3.2: Notification Service 用の ScaledObject を作成する（SQS ベース）**
...
**ステップ 3.3: Order Service 用の ScaledObject を作成する（Prometheus ベース）**
...
**ステップ 4.2: ArgoCD App-of-Apps を作成する**
...
**ステップ 4.3: MSA Service 用の ApplicationSet を作成する**
...
**ステップ 5.2: Instrumentation リソースを作成する**
...
**ステップ 6.2: AnalysisTemplate を作成する**
