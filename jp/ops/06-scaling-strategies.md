...
< [前へ: GitOps 自動化](05-gitops-automation.md) | [目次](./) | [次へ: 運用アラート設定](07-observability-alerts.md) >
...
![カスタムメトリクスパイプライン](../.gitbook/assets/custom_metrics_pipeline.png)
...
> **相互参照**: KEDA の基本とインストールについては、[KEDA Autoscaling](../autoscaling/01-keda.md) を参照してください
...
> **相互参照**: スケジューリングの基本については、[Scheduling, Preemption, and Eviction](../core/08-scheduling-preemption-eviction.md) を参照してください
...
### 5.3 PDB + Pod Deletion Cost の組み合わせ
...
### 5.4 Spot を使用した Topology Spread
