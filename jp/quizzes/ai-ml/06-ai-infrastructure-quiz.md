...
3g.20gb は1つの profile を表しており、three20GB のデバイスではありません。MIG は hardware を分割しますが、host/driver/authorization の isolation を置き換えるものではありません。MPS/time-slicing は security boundary ではありません。
</details>
