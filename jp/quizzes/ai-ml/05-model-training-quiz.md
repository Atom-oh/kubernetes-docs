...
activation checkpointing は memory と引き換えに backward recomputation を行います。これは disk 上の model/optimizer/RNG recovery state とは異なります。固定の3–4x の節約を前提とせず、use_reentrant、RNG/state、および gradient を確認してください。
</details>
