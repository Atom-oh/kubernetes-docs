...
flowchart TD
    ...
    style EKS fill:#f9f9f9,stroke:#333,stroke-width:1px
    style AWS fill:#FF9900,stroke:#FF9900,stroke-width:1px
    style Monitoring fill:#e6f7ff,stroke:#0099cc,stroke-width:1px
    style Logging fill:#e6ffe6,stroke:#009900,stroke-width:1px
```
