...
**설명:**
호환되지 않는 client는 활성화 후 canonical chain 추적을 중단하거나 갈라질 수 있으므로 process liveness만으로 정확성을 확인할 수 없습니다. 정상적인 전파·sync 지연을 고려하며 독립적인 신뢰 node 또는 explorer에서 **같은 block height와 finality 상태**의 hash를 비교합니다. 서로 다른 최신 head나 explorer 하나를 결정적 근거로 삼지 말고 client 버전·fork 인식·동기화 확인을 함께 사용합니다.
</details>
