...
![이미지가 Push되면 Lifecycle Policy가 rulePriority 순서로 규칙을 평가해 첫 번째로 매칭되는 규칙을 적용하고, 보존 기준을 초과한 이미지만 삭제하고 나머지는 보존하는 흐름을 보여준다.](../.gitbook/assets/ko-container-registry-02-amazon-ecr-1.png)
