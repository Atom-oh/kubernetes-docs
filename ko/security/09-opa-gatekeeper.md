...
![API 서버의 어드미션 웹훅 요청이 Gatekeeper Controller와 OPA Engine을 거쳐 평가되고, ConstraintTemplate이 정의한 Rego 정책을 Constraint가 대상 리소스에 적용하며 감사 결과가 남는 OPA Gatekeeper 아키텍처를 보여준다.](../.gitbook/assets/ko-security-09-opa-gatekeeper-0.png)
