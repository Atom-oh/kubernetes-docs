...
![AWS Management Console을 통한 EKS 클러스터 생성 워크플로우](../assets/generated-diagrams/eks_console_cluster_creation_workflow.png)
...
![AWS CLI를 통한 EKS 클러스터 생성 워크플로우](../assets/generated-diagrams/eks_cli_cluster_creation_workflow.png)
