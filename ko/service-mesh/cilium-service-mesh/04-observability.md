...
![각 노드의 eBPF 프로그램과 Cilium Agent가 수집한 흐름 데이터를 Hubble Observer가 모아 Hubble Relay로 전달하고, Relay는 Hubble UI·CLI로 시각화를 제공하며 Observer의 메트릭은 Prometheus를 거쳐 Grafana 대시보드로 흐르는 Hubble 아키텍처를 보여준다.](../../.gitbook/assets/ko-service-mesh-cilium-service-mesh-04-observability-0.png)
