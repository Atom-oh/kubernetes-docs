...
![애플리케이션 파드의 Envoy 프록시가 남긴 Access Log를 Promtail, Fluent Bit, OpenTelemetry Collector가 수집해 Loki와 Elasticsearch에 저장하고 Grafana로 조회하는 로그 파이프라인과, Telemetry API 설정을 istiod가 Envoy에 내려주는 제어 경로를 함께 보여준다.](../../../.gitbook/assets/ko-service-mesh-istio-observability-03-logging-0.png)

[🔍 인터랙티브 다이어그램 보기](https://www.atomai.click/kubernetes-docs/archmaps/ko-service-mesh-istio-observability-03-logging-0.html)
