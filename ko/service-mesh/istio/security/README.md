...
![Control Plane(istiod)의 Certificate Authority와 Configuration API가 두 파드의 Envoy 사이드카에 인증서와 정책을 배포하고, 사이드카 간 구간만 mTLS로 암호화되며, Identity부터 Authorization까지 5단계 보안 계층이 순서대로 적용되는 Istio 보안 아키텍처를 보여준다.](../../../.gitbook/assets/ko-service-mesh-istio-security-readme-0.png)
