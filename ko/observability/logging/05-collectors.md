...
![Promtail이 서비스 디스커버리로 대상을 찾고 파드 로그·Journal·Syslog를 스크랩한 뒤 파싱, 레이블·타임스탬프, output 파이프라인 스테이지를 거쳐 Loki push API로만 전송하는 구조를 보여준다.](../../.gitbook/assets/ko-observability-logging-05-collectors-2.png)

[🔍 인터랙티브 다이어그램 보기](https://www.atomai.click/kubernetes-docs/archmaps/ko-observability-logging-05-collectors-2.html)
...
[🔍 인터랙티브 다이어그램 보기](https://www.atomai.click/kubernetes-docs/archmaps/ko-observability-logging-05-collectors-3.html)
...
[🔍 인터랙티브 다이어그램 보기](https://www.atomai.click/kubernetes-docs/archmaps/ko-observability-logging-05-collectors-4.html)
