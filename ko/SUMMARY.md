...
* [네트워크 전문가 과정](networking/expert/README.md)
  * [1. 프로토콜·구현 프로젝트](networking/expert/01-protocol-projects.md)
  * [2. 라우팅 정책과 장애 수렴](networking/expert/02-routing-policy-convergence.md)
  * [3. 데이터센터 EVPN/VXLAN](networking/expert/03-datacenter-evpn.md)
  * [4. Linux 패킷 경로와 성능](networking/expert/04-linux-performance.md)
  * [5. 클라우드·CNI 설계](networking/expert/05-cloud-cni-design.md)
  * [6. 자동화와 종합 평가](networking/expert/06-automation-capstone.md)
...
* [LLM 게이트웨이(Inference Gateway) 딥다이브](ai-ml/08-llm-gateway.md)
...
* [SageMaker AI Qwen PII 가이드북](ai-ml/sagemaker-ai/README.md)
  * [실습: 합성 데이터와 증강](ai-ml/sagemaker-ai/06-data-augmentation-workshop.md)
  * [실습: QLoRA 학습과 SageMaker](ai-ml/sagemaker-ai/05-qlora-finetuning-workshop.md)
  * [실습: PII 평가와 비식별화](ai-ml/sagemaker-ai/07-pii-evaluation-release.md)
...
* AI/ML
  ...
  * [LLM 게이트웨이 퀴즈](quizzes/ai-ml/08-llm-gateway-quiz.md)
  ...
  * [SageMaker QLoRA 실습 퀴즈](quizzes/ai-ml/sagemaker-ai/05-qlora-finetuning-workshop-quiz.md)
  * [SageMaker 데이터 증강 실습 퀴즈](quizzes/ai-ml/sagemaker-ai/06-data-augmentation-workshop-quiz.md)
  * [SageMaker PII 평가 실습 퀴즈](quizzes/ai-ml/sagemaker-ai/07-pii-evaluation-release-quiz.md)
...
* Networking
  ...
  * 네트워크 전문가 과정
    * [프로토콜·구현 프로젝트 퀴즈](quizzes/networking/expert/01-protocol-projects-quiz.md)
    * [라우팅 정책과 장애 수렴 퀴즈](quizzes/networking/expert/02-routing-policy-convergence-quiz.md)
    * [데이터센터 EVPN/VXLAN 퀴즈](quizzes/networking/expert/03-datacenter-evpn-quiz.md)
    * [Linux 패킷 경로와 성능 퀴즈](quizzes/networking/expert/04-linux-performance-quiz.md)
    * [클라우드·CNI 설계 퀴즈](quizzes/networking/expert/05-cloud-cni-design-quiz.md)
    * [자동화와 종합 평가 퀴즈](quizzes/networking/expert/06-automation-capstone-quiz.md)
