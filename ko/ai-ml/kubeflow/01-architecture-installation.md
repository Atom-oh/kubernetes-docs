...
graph TB
    subgraph "Ingress / Auth"
        ...
        AUTH[AuthN/AuthZ<br/>Dex 또는 Cognito OIDC]
    end
    ...
    subgraph "멀티테넌시 계층"
        ...
        NS1[Kubeflow Profile<br/>네임스페이스: team-a]
        NS2[Kubeflow Profile<br/>네임스페이스: team-b]
    end

    subgraph "컴포넌트 컨트롤러 / CRD"
