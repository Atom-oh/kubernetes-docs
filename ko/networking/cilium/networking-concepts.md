...
![클라이언트가 루트, .com, example.com DNS 서버를 순서대로 거쳐 참조받으며 최종적으로 www.example.com의 IP 주소를 응답받는 반복(iterative) DNS 해석 과정을 보여준다.](../../.gitbook/assets/ko-networking-cilium-networking-concepts-10.png)
