...
![트래픽이 줄어 HPA가 스케일 다운되면 pod-deletion-cost가 0인 클라우드 Pod가 먼저 삭제되고 1000인 온프레미스 Pod는 유지되며, 비게 된 클라우드 노드는 Karpenter가 제거하는 흐름을 보여준다.](../.gitbook/assets/ko-eks-hybrid-nodes-06-workload-placement-0.png)
