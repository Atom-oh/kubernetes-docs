...
![AWS가 관리하는 MWAA 환경의 DAG가 S3에서 동기화된 kube_config.yaml로 별도 인프라인 사용자 EKS 클러스터에 Pod를 생성하고, eksctl iamidentitymapping으로 MWAA 실행 역할에 부여한 EKS RBAC 권한이 이 접근을 허용하는 과정을 보여준다.](../../.gitbook/assets/ko-data-on-eks-airflow-04-mwaa-integration-0.png)

[🔍 인터랙티브 다이어그램 보기](https://www.atomai.click/kubernetes-docs/archmaps/ko-data-on-eks-airflow-04-mwaa-integration-0.html)
