...
![KubernetesExecutor는 스케줄러가 태스크마다 일시적 Pod를 하나씩 생성하고, CeleryExecutor는 스케줄러가 Redis 브로커에 태스크를 큐잉하면 상시 실행 중인 warm 워커 Pod가 가져가 처리하는 두 실행 구조를 나란히 비교해 보여준다.](../../.gitbook/assets/ko-data-on-eks-airflow-02-helm-deployment-0.png)

[🔍 인터랙티브 다이어그램 보기](https://www.atomai.click/kubernetes-docs/archmaps/ko-data-on-eks-airflow-02-helm-deployment-0.html)
