...
![대기 중인 Spark 태스크를 본 DRA가 Executor 파드를 추가 요청하면 Karpenter가 Pending 파드를 위해 새 EC2 노드를 프로비저닝하고, 태스크가 소진되면 DRA가 유휴 Executor를 해제하고 Karpenter가 빈 노드를 회수해 다시 대기 상태로 돌아오는 두 스케일링 루프의 순환을 보여준다.](../../.gitbook/assets/ko-data-on-eks-spark-04-performance-tuning-0.png)

[🔍 인터랙티브 다이어그램 보기](https://www.atomai.click/kubernetes-docs/archmaps/ko-data-on-eks-spark-04-performance-tuning-0.html)
