...
![spark-submit 사용자의 요청으로 Kubernetes API 서버가 Driver Pod를 생성하고, Driver Pod가 다시 API 서버를 통해 Executor Pod들을 생성한 뒤 Executor가 Driver에 등록해 작업을 할당받고 결과를 보고하며, 작업이 끝나면 Driver가 Executor Pod를 정리하는 순서를 보여준다.](../../.gitbook/assets/ko-data-on-eks-spark-01-spark-fundamentals-0.png)

[🔍 인터랙티브 다이어그램 보기](https://www.atomai.click/kubernetes-docs/archmaps/ko-data-on-eks-spark-01-spark-fundamentals-0.html)
