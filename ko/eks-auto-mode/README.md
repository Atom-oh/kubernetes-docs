...
![사용자의 파드 생성 요청부터 EKS API Server의 Pending 감지, Auto Mode Controller의 NodePool 매칭과 인스턴스 타입 결정, EC2 Fleet의 신규 노드 프로비저닝, kubelet 등록과 파드 스케줄링을 거쳐 Pod Running에 이르는 EKS Auto Mode의 자동 노드 프로비저닝 흐름을 보여준다.](../.gitbook/assets/ko-eks-auto-mode-readme-0.png)
