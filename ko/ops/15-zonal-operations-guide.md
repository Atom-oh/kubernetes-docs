...
![컨슈머가 client.rack 정보를 담아 리더 브로커에 Fetch를 요청하면 리더가 같은 가용 영역(AZ-a)의 팔로워 브로커로 리다이렉트하고, 컨슈머는 그 팔로워에서 직접 데이터를 받아 크로스 AZ 전송 비용을 없애는 흐름을 보여준다.](../.gitbook/assets/ko-ops-15-zonal-operations-guide-10.png)
