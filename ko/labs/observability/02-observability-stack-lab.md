...
![MSA 앱, 노드 메트릭, K8s 이벤트가 OTel Collector의 Receivers·Processors·Exporters 파이프라인을 거쳐 메트릭·로깅·트레이싱 백엔드로 각각 분기되고, Grafana가 이를 통합 조회하는 Observability 스택 구조를 보여준다.](../../.gitbook/assets/ko-labs-observability-02-observability-stack-lab-0.png)
