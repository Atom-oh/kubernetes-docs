...
2. Crear la configuración del scheduler como ConfigMap:
...
3. Deployment del scheduler personalizado:
...
3. **Compilación y publicación de imagen**:
...
4. **Creación del ConfigMap de configuración del scheduler**:
...
5. **Deployment del scheduler personalizado**:
...
6. **Especificación del scheduler en el Pod**:
...
Para comprobar lo que has aprendido en este capítulo, prueba el [cuestionario del tema](../quizzes/scheduling/02-custom-scheduler-part2-quiz.md).
