...
- Practicar comandos de gestión de procesos de Linux
- Observar directamente el efecto de aislamiento de los namespaces de Linux
- Comprender los límites de recursos mediante cgroups
- Practicar la gestión de permisos y propiedad de archivos

## Requisitos previos
- [ ] Acceso a una terminal Linux (se recomienda Ubuntu 20.04+)
- [ ] Privilegios sudo
- [ ] Haber completado el aprendizaje de [conceptos básicos de Linux](../../basics/01-linux-basics.md)
...
- `kill -9 PID` termina el proceso forzosamente con SIGKILL
- `pkill -f "pattern"` permite terminar procesos por nombre
</details>
...
### Objetivo
Crear namespaces para observar el aislamiento de procesos y red.

### Pasos

**Paso 2.1: Verificar el aislamiento del namespace PID**
```bash
...
**Paso 2.2: Aislamiento del namespace de red**
```bash
...
- Las interfaces de red del host no son visibles dentro del namespace de red
...
## Ejercicio 3: Límites de recursos con cgroup
...
- Superar el límite produce el estado OOMKilled
