...
- [ ] Haber completado el aprendizaje [Habilidades de operaciones Linux](../../basics/02-linux-advanced.md)
...
**Paso 1.2: Consultas básicas con jq**
```bash
...
- `select(condition)` filtra solo los elementos que cumplen la condición
- `@tsv` genera la salida en formato separado por tabulaciones
- En K8s real, úsalo como `kubectl get pods -o json | jq '...'`
</details>
...
### Objetivo
Escribir scripts de shell simples útiles para operaciones de K8s.
