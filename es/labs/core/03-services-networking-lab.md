...
**Paso 2.1: Crear el Service NodePort**
```bash
...
## Ejercicio 3: Descubrimiento de Services mediante DNS
...
- Revisa los Pods de DNS con `kubectl get pods -n kube-system -l k8s-app=kube-dns`
</details>
...
## Siguientes pasos
- [Cuestionario de Services and Networking](../../quizzes/core/03-services-networking-quiz.md)
