# Guía de laboratorio de ConfigMap y Secret
...
- Comparar los métodos de variables de entorno y montaje de volumen

## Requisitos previos
- [ ] kubectl, Kubernetes cluster
- [ ] Haber completado el aprendizaje de [Configuración](../../core/05-configuration-secrets.md)
...
- Al montarlo como volumen, cada clave se convierte en un nombre de archivo
...
- En `kubectl get secret -o yaml`, los valores en el campo `.data` están codificados en base64
</details>

---

## Ejercicio 3: Comparación entre variables de entorno y montaje de volumen
...
- [Laboratorio de creación de EKS Cluster](../eks/01-eks-cluster-creation-lab.md)
