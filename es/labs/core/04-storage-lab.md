...
**Paso 1.2: Verificar el intercambio de datos entre containers**
```bash
...
- PV es un recurso a nivel de cluster, PVC es un recurso a nivel de namespace
- El estado `Bound` significa que PVC está enlazado a un PV
- `persistentVolumeReclaimPolicy: Retain` conserva los datos incluso después de eliminar PVC
</details>
...
**Paso 3.1: Comparar la información de los volúmenes**
```bash
echo "=== emptyDir Pod ==="
...
## Próximos pasos
- [Quiz de Storage](../../quizzes/core/04-storage-quiz.md)
