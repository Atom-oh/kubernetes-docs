...
- Realizar actualizaciones progresivas y rollbacks

## Prerrequisitos
- [ ] kubectl instalado y acceso al cluster (minikube o kind)
- [ ] Haber completado el aprendizaje de [Pods y Workloads](../../core/02-pods-and-workloads.md)

---

## Ejercicio 1: Creación y administración de Pods

### Pasos

**Paso 1.1: Escribir YAML del Pod**
```bash
...
**Paso 1.2: Verificar el estado del Pod**
```bash
...
**Paso 2.2: Verificar el estado del deployment**
```bash
...
- `kubectl get pods -w` monitorea los cambios en tiempo real
...
**Paso 3.1: Actualizar imagen**
```bash
kubectl set image deployment/nginx-deploy nginx=nginx:1.25 --record
kubectl rollout status deployment/nginx-deploy
```

**Paso 3.2: Revisar el historial de actualizaciones**
```bash
...
**Paso 4.2: Revisar el error y hacer rollback**
```bash
kubectl get pods -l app=nginx-deploy
...
## Siguientes pasos
- [Quiz de Pods y Workloads](../../quizzes/core/02-pods-and-workloads-quiz.md)
- [Laboratorio de Services y Networking](./03-services-networking-lab.md)
