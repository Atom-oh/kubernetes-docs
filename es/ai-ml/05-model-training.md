...
### Karpenter NodePool para auto-scaling de GPU
...
## Entrenamiento en AWS Trainium/Neuron
...
### Fine-tuning LoRA de Llama 3 en Trainium
...
### Entrenamiento de BERT-Large en Trainium con NeuronX Distributed
...
### Configuración de nodes Trainium
...
## Componentes de infraestructura de entrenamiento
...
### MPI Operator para workloads HPC tradicionales
...
### Volcano Scheduler para gang scheduling
...
### JupyterHub para desarrollo de entrenamiento interactivo
...
## Consejos de optimización del entrenamiento
...
### Configuración de Flash Attention
...
- [AI on EKS](https://awslabs.github.io/ai-on-eks/) - Guía y ejemplos de AWS para desplegar workloads de IA/ML en EKS
- [Slinky - Slurm on Kubernetes](https://github.com/SchedMD/slurm-operator) - Operador Slurm de SchedMD para Kubernetes
- [AWS Neuron Documentation](https://awsdocs.github.io/aws-neuron-documentation/) - Neuron SDK para Trainium e Inferentia
- [NVIDIA NCCL Documentation](https://docs.nvidia.com/deeplearning/nccl/) - Biblioteca de comunicación colectiva
- [DeepSpeed Documentation](https://www.deepspeed.ai/) - Biblioteca de entrenamiento distribuido de Microsoft
- [KubeRay Documentation](https://ray-project.github.io/kuberay/) - Ray en Kubernetes

## Quiz

Para probar lo que has aprendido en este capítulo, intenta el [quiz de entrenamiento de modelos](../quizzes/ai-ml/05-model-training-quiz.md).
