...
> **Versiones compatibles**: Falco 0.39+, Tetragon 1.2+, Kubernetes 1.31, 1.32, 1.33
> **Última actualización**: February 22, 2026

La seguridad en tiempo de ejecución implica detectar y responder a actividad maliciosa y comportamiento anómalo mientras los contenedores están en ejecución. Este documento cubre estrategias de seguridad en tiempo de ejecución centradas en Falco y Tetragon.
...
Falco es una herramienta de seguridad en tiempo de ejecución cloud-native que analiza llamadas al sistema para detectar comportamiento anómalo.
...
Tetragon es una herramienta de observabilidad de seguridad y aplicación de controles en tiempo de ejecución basada en eBPF, del proyecto Cilium.
...
Aspectos clave de la seguridad en tiempo de ejecución:

1. **Falco**: Conjunto de reglas maduro, integración diversa de alertas, enfocado en la detección
2. **Tetragon**: Alto rendimiento basado en eBPF, soporte para aplicación de controles en tiempo de ejecución
3. **Audit Logging**: Seguimiento de la actividad de la API de Kubernetes, cumplimiento
4. **Threat Detection**: Minería de criptomonedas, reverse shells, escalamiento de privilegios
5. **Incident Response**: Aislamiento, recopilación de evidencia, análisis forense

### Recommendations

- Usar la combinación de Falco + Tetragon para detección y aplicación de controles
- Escribir reglas personalizadas para sistemas críticos
- Integrar con SIEM para monitoreo centralizado
- Preparar playbooks de respuesta a incidentes
