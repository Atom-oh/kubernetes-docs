# Mejores prácticas de Cilium Service Mesh
...
Este capítulo cubre las mejores prácticas para operar Cilium Service Mesh en entornos de producción. Incluye listas de verificación de despliegue, dimensionamiento de recursos, ajuste de rendimiento, migración desde mesh con sidecar, estrategias de actualización y guías de solución de problemas.
...
### values.yaml de Helm recomendados
...
| Tamaño | Nodos | Pods | Cilium Agent | Envoy | Hubble Relay |
|------|-------|------|--------------|-------|--------------|
| Pequeño | 1-10 | <500 | 500m/512Mi | 200m/256Mi | 100m/128Mi |
| Mediano | 10-50 | 500-2000 | 1000m/1Gi | 500m/512Mi | 200m/256Mi |
| Grande | 50-200 | 2000-10000 | 2000m/2Gi | 1000m/1Gi | 500m/512Mi |
| Extragrande | 200+ | 10000+ | 4000m/4Gi | 2000m/2Gi | 1000m/1Gi |

### Cálculo de recursos de Cilium Agent
...
### Dimensionamiento de mapas eBPF
...
### Ajuste de rendimiento de Envoy
...
## Migración desde mesh con sidecar
...
#### Paso 1: Instalar Cilium (coexistencia con Istio)
...
#### Paso 2: Convertir por Namespace
...
#### Paso 3: Ejemplos de conversión de políticas
...
### Usar solo L3/L4 (mantener Istio L7)
...
#### 1. Error de conexión de red de Pod
...
## Recomendaciones específicas de EKS

### Integración de VPC CNI
...
1. **Dimensionamiento de recursos**: Configure los recursos de Agent y Envoy según el tamaño del clúster
2. **Seguridad**: Habilite el cifrado WireGuard y mTLS
3. **Observabilidad**: La recopilación de métricas de Hubble y Prometheus es esencial
4. **Adopción gradual**: Migre desde el mesh existente por etapas
5. **Monitoreo**: Configure alertas para las métricas principales

### Recursos adicionales

- [Documentación oficial de Cilium](https://docs.cilium.io/)
- [Comunidad de Cilium en Slack](https://cilium.herokuapp.com/)
- [Cilium GitHub](https://github.com/cilium/cilium)
- [Recursos de aprendizaje de eBPF](https://ebpf.io/)

## Referencias

- [Guía de producción de Cilium](https://docs.cilium.io/en/stable/operations/performance/)
- [Solución de problemas de Cilium](https://docs.cilium.io/en/stable/operations/troubleshooting/)
- [Guía de actualización de Cilium](https://docs.cilium.io/en/stable/operations/upgrade/)
- [Migración de Istio a Cilium](https://docs.cilium.io/en/stable/network/servicemesh/istio-migration/)
