...
- [Manual de resolución de problemas, entrada 11 — No se puede crear ningún Service: failed calling webhook (English)](https://www.atomai.click/kubernetes-docs/en/ops/16-troubleshooting-playbook#11-no-service-can-be-created-failed-calling-webhook) — la interrupción que dejó ClusterIP fuera de este benchmark
