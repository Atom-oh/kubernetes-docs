...
< [Anterior: Automatización GitOps](05-gitops-automation.md) | [Tabla de contenidos](./) | [Siguiente: Configuración de alertas operativas](07-observability-alerts.md) >
...
![Pipeline de métricas personalizadas](../.gitbook/assets/custom_metrics_pipeline.png)
...
> **Referencia cruzada**: Para fundamentos e instalación de KEDA, consulte [Autoscaling de KEDA](../autoscaling/01-keda.md)
...
> **Referencia cruzada**: Para fundamentos de scheduling, consulte [Scheduling, Preemption y Eviction](../core/08-scheduling-preemption-eviction.md)
...
| **KEDA**                | Basado en eventos, scale-to-zero            | ScaledObject + Triggers            |
| **VPA**                 | Right-sizing, optimización de memoria       | UpdateMode + Resource Policies     |
| **Pod Deletion Cost**   | Preferencia por Spot, finalización de Job   | Annotation + Custom Controller     |
| **Uso de Spot**         | Optimización de costos                      | NodePools + Topology Spread        |
