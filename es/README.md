...
Este repositorio es una guía integral de la nube que abarca los fundamentos de Linux y contenedores, Kubernetes y Amazon EKS, redes, service mesh (malla de servicios), almacenamiento, bases de datos, canalizaciones de datos, IA/ML y seguridad y operaciones. Además del material de aprendizaje, ofrece datos de benchmark medidos en entornos reales de AWS, junto con cuestionarios por tema y laboratorios prácticos seleccionados.

## Material de aprendizaje y cuestionarios

Este contenido de formación ofrece cuestionarios para cada tema junto con el material de aprendizaje. Puedes poner a prueba y reforzar lo aprendido mediante los cuestionarios. Cada cuestionario está diseñado con respuestas ocultas de tipo desplegable, lo que te permite intentar responder las preguntas antes de revelar las respuestas.

- [Índice del material de aprendizaje](#table-of-contents) - Material de aprendizaje por tema
...
- [Lectura con LLM](./llm-guide.md) - Encuentra y lee el material fuente a través de llms.txt, el manifiesto y MCP | [Cuestionario](./quizzes/llm-guide-quiz.md)
...
2. [Funciones del kernel detrás de los contenedores](./kernel/01-container-primitives.md) | [Cuestionario](./quizzes/kernel/01-container-primitives-quiz.md)
3. [Pila de red del kernel](./kernel/02-network-stack.md) | [Cuestionario](./quizzes/kernel/02-network-stack-quiz.md)
4. [Ajuste del kernel de los nodos de EKS](./kernel/03-eks-node-tuning.md) | [Cuestionario](./quizzes/kernel/03-eks-node-tuning-quiz.md)
...
9. [Programación, preemption y desalojo](./core/08-scheduling-preemption-eviction.md) | [Cuestionario](./quizzes/core/08-scheduling-preemption-eviction-quiz.md) | [Laboratorio](./labs/core/08-scheduling-preemption-eviction-lab.md)
10. [Administración del clúster](./core/09-cluster-administration.md) | [Cuestionario](./quizzes/core/09-cluster-administration-quiz.md)
...
13. Scheduler personalizado
   ...
   - [Parte 3: Ejemplos de implementación de un scheduler personalizado y monitoreo](./scheduling/03-custom-scheduler-part3.md) | [Cuestionario](./quizzes/scheduling/02-custom-scheduler-part3-quiz.md)
14. Autoescalado
...
2. Creación de clústeres de EKS
   ...
   - [Parte 2: Crear clústeres con eksctl](./eks/02-eks-cluster-creation-part2.md) | [Cuestionario](./quizzes/eks/02-eks-cluster-creation-part2-quiz.md)
   - [Parte 3: Crear clústeres con la consola de administración de AWS y la CLI](./eks/02-eks-cluster-creation-part3.md) | [Cuestionario](./quizzes/eks/02-eks-cluster-creation-part3-quiz.md)
   - [Parte 4: Crear clústeres con Terraform y CDK](./eks/02-eks-cluster-creation-part4.md) | [Cuestionario](./quizzes/eks/02-eks-cluster-creation-part4-quiz.md)
...
4. Almacenamiento en EKS
   ...
   - [Parte 3: Monitoreo, resolución de problemas, optimización de costos, seguridad](./eks/04-eks-storage-part3.md) | [Cuestionario](./quizzes/eks/04-eks-storage-part3-quiz.md)
5. [Seguridad en EKS](./eks/05-eks-security.md) | [Cuestionario](./quizzes/eks/05-eks-security-quiz.md)
6. [Monitoreo y registro de logs en EKS](./eks/06-eks-monitoring-logging.md) | [Cuestionario](./quizzes/eks/06-eks-monitoring-logging-quiz.md)
7. [Optimización de costos en EKS](./eks/07-eks-cost-optimization.md) | [Cuestionario](./quizzes/eks/07-eks-cost-optimization-quiz.md)
...
12. [Funcionalidades por versión de Kubernetes y hoja de ruta](./eks/12-kubernetes-version-roadmap.md) | [Cuestionario](./quizzes/eks/12-kubernetes-version-roadmap-quiz.md)
...
4. [Configuración con acceso restringido a Internet](./eks-hybrid-nodes/03-airgap-setup.md) | [Cuestionario](./quizzes/eks-hybrid-nodes/03-airgap-setup-quiz.md)
...
10. [Configuración del sistema operativo en bare metal](./eks-hybrid-nodes/09-bare-metal-os-setup.md) | [Cuestionario](./quizzes/eks-hybrid-nodes/09-bare-metal-os-setup-quiz.md)
...
12. [Revisión de seguridad de la separación de redes](./eks-hybrid-nodes/11-network-separation-security.md) | [Cuestionario](./quizzes/eks-hybrid-nodes/11-network-separation-security-quiz.md)
...
1. [Redes en Linux desde cero](./networking/beginner/README.md)
   - [1. Linux y la CLI](./networking/beginner/01-linux-cli.md) | [Cuestionario](./quizzes/networking/beginner/01-linux-cli-quiz.md)
   - [2. Direcciones e interfaces](./networking/beginner/02-addressing-interfaces.md) | [Cuestionario](./quizzes/networking/beginner/02-addressing-interfaces-quiz.md)
   - [3. Configuración de red persistente](./networking/beginner/03-persistent-configuration.md) | [Cuestionario](./quizzes/networking/beginner/03-persistent-configuration-quiz.md)
   - [4. DNS y conectividad](./networking/beginner/04-dns-connectivity.md) | [Cuestionario](./quizzes/networking/beginner/04-dns-connectivity-quiz.md)
   - [5. Acceso remoto con SSH](./networking/beginner/05-ssh-access.md) | [Cuestionario](./quizzes/networking/beginner/05-ssh-access-quiz.md)
   - [6. Firewalls y seguridad del host](./networking/beginner/06-firewalls-host-security.md) | [Cuestionario](./quizzes/networking/beginner/06-firewalls-host-security-quiz.md)
   - [7. Monitoreo y rendimiento](./networking/beginner/07-monitoring-performance.md) | [Cuestionario](./quizzes/networking/beginner/07-monitoring-performance-quiz.md)
   - [8. Proyecto final y conexiones a la nube](./networking/beginner/08-container-cloud-capstone.md) | [Cuestionario](./quizzes/networking/beginner/08-container-cloud-capstone-quiz.md)
2. [Ruta de redes para expertos](./networking/expert/README.md)
   - [1. Proyectos de protocolos](./networking/expert/01-protocol-projects.md) | [Cuestionario](./quizzes/networking/expert/01-protocol-projects-quiz.md)
   - [2. Política de enrutamiento y convergencia](./networking/expert/02-routing-policy-convergence.md) | [Cuestionario](./quizzes/networking/expert/02-routing-policy-convergence-quiz.md)
   - [3. EVPN/VXLAN en centros de datos](./networking/expert/03-datacenter-evpn.md) | [Cuestionario](./quizzes/networking/expert/03-datacenter-evpn-quiz.md)
   - [4. Rutas de paquetes y rendimiento en Linux](./networking/expert/04-linux-performance.md) | [Cuestionario](./quizzes/networking/expert/04-linux-performance-quiz.md)
   - [5. Diseño de nube y CNI](./networking/expert/05-cloud-cni-design.md) | [Cuestionario](./quizzes/networking/expert/05-cloud-cni-design-quiz.md)
   - [6. Automatización y evaluación final](./networking/expert/06-automation-capstone.md) | [Cuestionario](./quizzes/networking/expert/06-automation-capstone-quiz.md)
3. [Descripción general de las redes en Kubernetes](./networking/README.md) | [Cuestionario](./quizzes/networking/00-networking-overview-quiz.md)
4. [Fundamentos de redes — 25 protocolos](./basics/06-network-fundamentals-part1.md)
   - [Parte 1: El modelo de capas, las capas de enlace y enrutamiento](./basics/06-network-fundamentals-part1.md) | [Cuestionario](./quizzes/basics/06-network-fundamentals-part1-quiz.md)
...
5. [Práctica de diagnóstico de red en Linux](./networking/07-linux-network-diagnostics.md) | [Cuestionario](./quizzes/networking/07-linux-network-diagnostics-quiz.md)
6. [VPC CNI](./networking/01-vpc-cni.md) | [Cuestionario](./quizzes/networking/01-vpc-cni-quiz.md)
7. **Cilium en profundidad**
...
9. [VPC Lattice](./networking/02-vpc-lattice.md) | [Cuestionario](./quizzes/networking/02-vpc-lattice-quiz.md)
10. [AWS Load Balancer Controller](./networking/03-aws-lb-controller.md) | [Cuestionario](./quizzes/networking/03-aws-lb-controller-quiz.md)
11. [Gateway API](./networking/04-gateway-api.md) | [Cuestionario](./quizzes/networking/04-gateway-api-quiz.md)
12. [Conectividad de VPC entre organizaciones](./networking/05-cross-org-vpc-connectivity.md) | [Cuestionario](./quizzes/networking/05-cross-org-vpc-connectivity-quiz.md)
13. [Benchmark de red de Pods](./networking/06-pod-network-benchmark.md) | [Cuestionario](./quizzes/networking/06-pod-network-benchmark-quiz.md)
...
4. **VPC Lattice en profundidad**
   - [Descripción general de VPC Lattice en profundidad](./service-mesh/vpc-lattice/README.md)
   ...
   - [Análisis del impacto en la latencia](./service-mesh/vpc-lattice/02-latency.md) | [Cuestionario](./quizzes/service-mesh/vpc-lattice/02-latency-quiz.md)
   - [Flujo de autenticación de IAM](./service-mesh/vpc-lattice/03-auth-flow.md) | [Cuestionario](./quizzes/service-mesh/vpc-lattice/03-auth-flow-quiz.md)
   ...
   - [Migración de la identidad de las cargas de trabajo](./service-mesh/vpc-lattice/05-spiffe-to-iam.md) | [Cuestionario](./quizzes/service-mesh/vpc-lattice/05-spiffe-to-iam-quiz.md)
...
3. [Ejecutar nodos de blockchain en EKS](./blockchain/02-nodes-on-eks.md) | [Cuestionario](./quizzes/blockchain/02-nodes-on-eks-quiz.md)
...
5. [Perspectiva de los servicios financieros](./blockchain/04-financial-services.md) | [Cuestionario](./quizzes/blockchain/04-financial-services-quiz.md)
...
1. [Descripción general de Data on EKS](./data-on-eks/README.md)
   ...
   - [Gobernanza en SageMaker Unified Studio](./data-on-eks/sagemaker-unified-studio/README.md)
...
2. **Kafka en EKS en profundidad**
   ...
   - [Parte 7: Monitoreo](./data-on-eks/kafka/07-monitoring.md) | [Cuestionario](./quizzes/data-on-eks/kafka/07-monitoring-quiz.md)
...
3. **Spark en EKS en profundidad**
   ...
   - [Parte 4: Ajuste de rendimiento y costos](./data-on-eks/spark/04-performance-tuning.md) | [Cuestionario](./quizzes/data-on-eks/spark/04-performance-tuning-quiz.md)
...
10. **MLflow en EKS en profundidad**
   ...
   - [Parte 3: Desplegar MLflow en EKS](./ai-ml/mlflow/03-eks-deployment.md) | [Cuestionario](./quizzes/ai-ml/mlflow/03-eks-deployment-quiz.md)
11. **Guía de PII con Qwen en SageMaker AI**
   ...
   - [Parte 2: Datos sintéticos de PII y tokenización](./ai-ml/sagemaker-ai/02-pii-data-tokenization.md) | [Cuestionario](./quizzes/ai-ml/sagemaker-ai/02-pii-data-tokenization-quiz.md)
   ...
   - [Parte 4: Gobernanza en Unified Studio](./data-on-eks/sagemaker-unified-studio/01-domains-projects-governance.md) | [Cuestionario](./quizzes/data-on-eks/sagemaker-unified-studio/01-domains-projects-governance-quiz.md)
...
5. [Gestión de secretos](./security/05-secrets-management.md) | [Cuestionario](./quizzes/security/05-secrets-management-quiz.md)
...
8. [Seguridad en tiempo de ejecución](./security/08-runtime-security.md) | [Cuestionario](./quizzes/security/08-runtime-security-quiz.md)
...
2. **ArgoCD**
   ...
   - [Experimentos de Rollouts en profundidad](./gitops/argocd/10-rollouts-experiment.md) | [Cuestionario](./quizzes/gitops/argocd/10-rollouts-experiment-quiz.md)
...
1. [Descripción general de la gobernanza](./governance/00-governance-overview.md) | [Cuestionario](./quizzes/governance/00-governance-overview-quiz.md)
...
4. [Arquitectura de EKS con múltiples cuentas y múltiples clústeres](./governance/03-eks-multi-account-multi-cluster.md) | [Cuestionario](./quizzes/governance/03-eks-multi-account-multi-cluster-quiz.md)
...
6. [Límites de datos y de seguridad](./governance/05-data-security-boundaries.md) | [Cuestionario](./quizzes/governance/05-data-security-boundaries-quiz.md)
7. [Marco de decisión y diseño de la PoC](./governance/06-decision-framework-and-poc.md) | [Cuestionario](./quizzes/governance/06-decision-framework-and-poc-quiz.md)
...
5. [Buenas prácticas para el registro de contenedores](./container-registry/04-best-practices.md) | [Cuestionario](./quizzes/container-registry/04-best-practices-quiz.md)

### Observabilidad
1. [Descripción general de la observabilidad](./observability/README.md)
2. **Métricas**
   - [Descripción general de las métricas](./observability/metrics/README.md) | [Cuestionario](./quizzes/observability/metrics/00-metrics-overview-quiz.md)
...
3. **Registro de logs**
   - [Descripción general del registro de logs](./observability/logging/README.md) | [Cuestionario](./quizzes/observability/logging/README-quiz.md)
...
4. **Trazas**
   - [Descripción general de las trazas](./observability/tracing/README.md)
...
5. **Alertas**
   - [Descripción general de las alertas](./observability/alerting/README.md)
...
3. [Canalizaciones de CI](./ops/03-ci-pipelines.md) | [Cuestionario](./quizzes/ops/03-ci-pipelines-quiz.md)
...
13. [Plataforma FinOps de visibilidad de costos](./ops/13-finops-cost-platform.md) | [Cuestionario](./quizzes/ops/13-finops-cost-platform-quiz.md)
14. [Tekton Pipelines](./ops/14-tekton-pipelines.md) | [Cuestionario](./quizzes/ops/14-tekton-pipelines-quiz.md)
15. [Operaciones de clústeres zonales](./ops/15-zonal-operations-guide.md) | [Cuestionario](./quizzes/ops/15-zonal-operations-guide-quiz.md)
...
17. [Experimentos con Spot en producción en EKS y evaluación de resultados](./ops/17-spot-production-experiments.md) | [Cuestionario](./quizzes/ops/17-spot-production-experiments-quiz.md)

## Guías de laboratorio

Ofrecemos guías de laboratorio prácticas para practicar en entornos reales después de aprender la teoría.
...
- Piensa primero en las respuestas de tipo desplegable antes de revelarlas
- Repasa el documento correspondiente para cualquier pregunta que hayas fallado

## Contribuir

Si quieres contribuir a este proyecto:
1. Envía un issue cuando encuentres errores tipográficos o de contenido
