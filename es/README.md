...
Este repositorio proporciona materiales de formación completos sobre Kubernetes y Amazon EKS. Abarca todo, desde los fundamentos de Linux hasta la contenerización, la orquestación de Kubernetes y las funciones avanzadas de Amazon EKS.

## Materiales de aprendizaje y cuestionarios

Este contenido de formación proporciona cuestionarios para cada tema junto con los materiales de aprendizaje. Puedes poner a prueba y reforzar lo que has aprendido mediante los cuestionarios. Cada cuestionario está diseñado con respuestas de estilo desplegable ocultas, lo que te permite intentar responder las preguntas antes de revelar las respuestas.
...
1. [Arquitectura del clúster](./core/01-cluster-architecture.md) | [Cuestionario](./quizzes/core/01-cluster-architecture-quiz.md)
2. [Pods y cargas de trabajo](./core/02-pods-and-workloads.md) | [Cuestionario](./quizzes/core/02-pods-and-workloads-quiz.md)
3. [Services y redes](./core/03-services-networking.md) | [Cuestionario](./quizzes/core/03-services-networking-quiz.md)
4. [Almacenamiento](./core/04-storage.md) | [Cuestionario](./quizzes/core/04-storage-quiz.md)
5. [Configuración](./core/05-configuration-secrets.md) | [Cuestionario](./quizzes/core/05-configuration-secrets-quiz.md)
6. [Seguridad](./core/06-security.md) | [Cuestionario](./quizzes/core/06-security-quiz.md)
7. [Políticas](./core/07-policies.md) | [Cuestionario](./quizzes/core/07-policies-quiz.md)
8. [Planificación, apropiación y expulsión](./core/08-scheduling-preemption-eviction.md) | [Cuestionario](./quizzes/core/08-scheduling-preemption-eviction-quiz.md)
9. [Administración del clúster](./core/09-cluster-administration.md) | [Cuestionario](./quizzes/core/09-cluster-administration-quiz.md)
...
2. Creación de clústeres EKS
   ...
   - [Parte 5: Acceso, validación, actualización y eliminación del clúster](./eks/02-eks-cluster-creation-part5.md) | [Cuestionario](./quizzes/eks/02-eks-cluster-creation-part5-quiz.md)
3. Redes de EKS
   ...
   - [Parte 3: Optimización del rendimiento, resolución de problemas y casos de uso avanzados](./eks/03-eks-networking-part3.md) | [Cuestionario](./quizzes/eks/03-eks-networking-part3-quiz.md)
4. Almacenamiento de EKS
   ...
   - [Parte 2: FSx for Lustre, S3, snapshots, expansión de volumen y optimización del rendimiento](./eks/04-eks-storage-part2.md) | [Cuestionario](./quizzes/eks/04-eks-storage-part2-quiz.md)
   - [Parte 3: Monitoreo, resolución de problemas, optimización de costos y seguridad](./eks/04-eks-storage-part3.md) | [Cuestionario](./quizzes/eks/04-eks-storage-part3-quiz.md)
...
12. [Funciones y hoja de ruta de versiones de Kubernetes](./eks/12-kubernetes-version-roadmap.md) | [Cuestionario](./quizzes/eks/12-kubernetes-version-roadmap-quiz.md)
...
4. [Configuración de entorno aislado de red](./eks-hybrid-nodes/03-airgap-setup.md) | [Cuestionario](./quizzes/eks-hybrid-nodes/03-airgap-setup-quiz.md)
5. [Bootstrap de nodo](./eks-hybrid-nodes/04-node-bootstrap.md) | [Cuestionario](./quizzes/eks-hybrid-nodes/04-node-bootstrap-quiz.md)
6. [Integración de servidor GPU](./eks-hybrid-nodes/05-gpu-integration.md) | [Cuestionario](./quizzes/eks-hybrid-nodes/05-gpu-integration-quiz.md)
...
7. [Mejores prácticas de IA/ML](./ai-ml/07-ai-ml-best-practices.md) | [Cuestionario](./quizzes/ai-ml/07-ai-ml-best-practices-quiz.md)
8. **Análisis en profundidad de Kubeflow en EKS**
...
9. **Análisis en profundidad de MLflow en EKS**
...
### Datos en EKS
1. [Resumen de datos en EKS](./data-on-eks/README.md)
2. **Análisis en profundidad de Kafka en EKS**
   ...
   - [Parte 4: Registro de esquemas](./data-on-eks/kafka/04-schema-registry.md) | [Cuestionario](./quizzes/data-on-eks/kafka/04-schema-registry-quiz.md)
...
3. **Análisis en profundidad de Spark en EKS**
   ...
   - [Parte 2: Operador de Spark](./data-on-eks/spark/02-spark-operator.md) | [Cuestionario](./quizzes/data-on-eks/spark/02-spark-operator-quiz.md)
...
4. **Análisis en profundidad de Airflow en EKS**
   ...
   - [Parte 2: Despliegue de Helm y elección del executor](./data-on-eks/airflow/02-helm-deployment.md) | [Cuestionario](./quizzes/data-on-eks/airflow/02-helm-deployment-quiz.md)
   - [Parte 3: Patrones DAG y KubernetesPodOperator](./data-on-eks/airflow/03-dag-patterns.md) | [Cuestionario](./quizzes/data-on-eks/airflow/03-dag-patterns-quiz.md)
...
5. **Análisis en profundidad de Flink en EKS**
   ...
   - [Parte 2: Operador de Flink para Kubernetes](./data-on-eks/flink/02-flink-kubernetes-operator.md) | [Cuestionario](./quizzes/data-on-eks/flink/02-flink-kubernetes-operator-quiz.md)
...
### Redes
1. [Resumen de redes](./networking/README.md) | [Cuestionario](./quizzes/networking/00-networking-overview-quiz.md)
2. [VPC CNI](./networking/01-vpc-cni.md) | [Cuestionario](./quizzes/networking/01-vpc-cni-quiz.md)
3. **Análisis en profundidad de Cilium**
...
4. **Análisis en profundidad de Calico**
...
3. **Service Mesh de Cilium**
   - [Introducción a Service Mesh de Cilium](./service-mesh/cilium-service-mesh/README.md)
...
1. [Resumen del registro de contenedores](./container-registry/README.md)
...
5. [Mejores prácticas del registro de contenedores](./container-registry/04-best-practices.md) | [Cuestionario](./quizzes/container-registry/04-best-practices-quiz.md)

### Ingeniería de plataformas
0. [Resumen de ingeniería de plataformas](./platform-engineering/00-platform-engineering-overview.md) | [Cuestionario](./quizzes/platform-engineering/00-platform-engineering-overview-quiz.md)
...
### GitOps
1. [Resumen de GitOps](./gitops/README.md)
2. **ArgoCD**
...
12. [Guía de planificación de capacidad para eventos](./ops/12-event-capacity-planning.md) | [Cuestionario](./quizzes/ops/12-event-capacity-planning-quiz.md)
...
15. [Operaciones de clúster zonal](./ops/15-zonal-operations-guide.md) | [Cuestionario](./quizzes/ops/15-zonal-operations-quiz.md)

### Observabilidad
1. [Resumen de observabilidad](./observability/README.md)
2. **Métricas**
   - [Resumen de métricas](./observability/metrics/README.md) | [Cuestionario](./quizzes/observability/metrics/00-metrics-overview-quiz.md)
...
3. **Logging**
   - [Resumen de logging](./observability/logging/README.md)
   ...
   - [Logs de CloudWatch](./observability/logging/03-cloudwatch-logs.md) | [Cuestionario](./quizzes/observability/logging/03-cloudwatch-logs-quiz.md)
...
4. **Trazabilidad**
   - [Resumen de trazabilidad](./observability/tracing/README.md)
...
5. **Alertas**
   - [Resumen de alertas](./observability/alerting/README.md)
...
- Fundamentos: fundamentos de Linux, operaciones de Linux, laboratorios de contenedores
- Principales: laboratorios de Pod, Service, almacenamiento y ConfigMap
...
7. [Parte 6: Análisis de trazabilidad distribuida](./labs/observability/06-distributed-tracing-lab.md) | [Cuestionario](./quizzes/observability/labs/06-distributed-tracing-quiz.md)
...
3. Ejecuta los comandos y el código de ejemplo de forma práctica en un entorno de práctica
...
2. Propón temas nuevos o mejoras
3. Propón adiciones o mejoras a las preguntas de los cuestionarios

## Licencia

Este material de formación se puede usar gratuitamente con fines de aprendizaje.
