...
- [Lectura con LLM](./llm-guide.md) - Busque y lea el material fuente mediante llms.txt, el manifiesto y MCP | [Cuestionario](./quizzes/llm-guide-quiz.md)
...
1. [Conceptos básicos de Linux](./basics/01-linux-basics.md) | [Cuestionario](./quizzes/basics/01-linux-basics-quiz.md) | [Laboratorio](./labs/basics/01-linux-basics-lab.md)
...
9. [Programación, preempción y expulsión](./core/08-scheduling-preemption-eviction.md) | [Cuestionario](./quizzes/core/08-scheduling-preemption-eviction-quiz.md)
...
13. Scheduler personalizado
   - [Parte 1: Conceptos básicos del scheduler personalizado](./scheduling/01-custom-scheduler-part1.md) | [Cuestionario](./quizzes/scheduling/02-custom-scheduler-part1-quiz.md)
   ...
   - [Parte 3: Ejemplos de implementación y monitoreo de scheduler personalizado](./scheduling/03-custom-scheduler-part3.md) | [Cuestionario](./quizzes/scheduling/02-custom-scheduler-part3-quiz.md)
14. Autoescalado
...
3. Redes EKS
   ...
   - [Parte 2: Services, balanceo de carga y políticas de red](./eks/03-eks-networking-part2.md) | [Cuestionario](./quizzes/eks/03-eks-networking-part2-quiz.md)
   - [Parte 3: Optimización del rendimiento, solución de problemas y casos de uso avanzados](./eks/03-eks-networking-part3.md) | [Cuestionario](./quizzes/eks/03-eks-networking-part3-quiz.md)
4. Almacenamiento EKS
   - [Parte 1: Conceptos básicos, EBS y EFS](./eks/04-eks-storage-part1.md) | [Cuestionario](./quizzes/eks/04-eks-storage-part1-quiz.md)
   - [Parte 2: FSx for Lustre, S3, snapshots, expansión de volúmenes y optimización del rendimiento](./eks/04-eks-storage-part2.md) | [Cuestionario](./quizzes/eks/04-eks-storage-part2-quiz.md)
   - [Parte 3: Monitoreo, solución de problemas, optimización de costos y seguridad](./eks/04-eks-storage-part3.md) | [Cuestionario](./quizzes/eks/04-eks-storage-part3-quiz.md)
5. [Seguridad de EKS](./eks/05-eks-security.md) | [Cuestionario](./quizzes/eks/05-eks-security-quiz.md)
6. [Monitoreo y logging de EKS](./eks/06-eks-monitoring-logging.md) | [Cuestionario](./quizzes/eks/06-eks-monitoring-logging-quiz.md)
...
9. [Solución de problemas de EKS](./eks/09-eks-troubleshooting.md) | [Cuestionario](./quizzes/eks/09-eks-troubleshooting-quiz.md)
...
4. [Configuración de Internet restringido](./eks-hybrid-nodes/03-airgap-setup.md) | [Cuestionario](./quizzes/eks-hybrid-nodes/03-airgap-setup-quiz.md)
...
10. [Configuración del SO bare metal](./eks-hybrid-nodes/09-bare-metal-os-setup.md) | [Cuestionario](./quizzes/eks-hybrid-nodes/09-bare-metal-os-setup-quiz.md)
...
1. [Redes Linux desde el principio](./networking/beginner/README.md)
   ...
   - [8. Proyecto final y conexiones en la nube](./networking/beginner/08-container-cloud-capstone.md) | [Cuestionario](./quizzes/networking/beginner/08-container-cloud-capstone-quiz.md)
2. [Ruta de redes para expertos](./networking/expert/README.md)
   ...
   - [2. Políticas de enrutamiento y convergencia](./networking/expert/02-routing-policy-convergence.md) | [Cuestionario](./quizzes/networking/expert/02-routing-policy-convergence-quiz.md)
   - [3. EVPN/VXLAN de centro de datos](./networking/expert/03-datacenter-evpn.md) | [Cuestionario](./quizzes/networking/expert/03-datacenter-evpn-quiz.md)
   - [4. Rutas de paquetes y rendimiento de Linux](./networking/expert/04-linux-performance.md) | [Cuestionario](./quizzes/networking/expert/04-linux-performance-quiz.md)
...
3. [Descripción general de las redes de Kubernetes](./networking/README.md) | [Cuestionario](./quizzes/networking/00-networking-overview-quiz.md)
4. [Fundamentos de redes — 25 protocolos](./basics/06-network-fundamentals-part1.md)
   ...
   - [Parte 4: El recorrido de una solicitud y la nube](./basics/06-network-fundamentals-part4.md) | [Cuestionario](./quizzes/basics/06-network-fundamentals-part4-quiz.md)
5. [Práctica de diagnóstico de red de Linux](./networking/07-linux-network-diagnostics.md) | [Cuestionario](./quizzes/networking/07-linux-network-diagnostics-quiz.md)
6. [VPC CNI](./networking/01-vpc-cni.md) | [Cuestionario](./quizzes/networking/01-vpc-cni-quiz.md)
7. **Análisis profundo de Cilium**
...
8. **Análisis profundo de Calico**
   ...
   - [Parte 6: Plano de datos eBPF](./networking/calico/06-ebpf-dataplane.md) | [Cuestionario](./quizzes/networking/calico/06-ebpf-dataplane-quiz.md)
...
12. [Conectividad VPC entre organizaciones](./networking/05-cross-org-vpc-connectivity.md) | [Cuestionario](./quizzes/networking/05-cross-org-vpc-connectivity-quiz.md)
...
4. **Análisis profundo de VPC Lattice**
   - [Descripción general del análisis profundo de VPC Lattice](./service-mesh/vpc-lattice/README.md)
   ...
   - [Migración de identidad de carga de trabajo](./service-mesh/vpc-lattice/05-spiffe-to-iam.md) | [Cuestionario](./quizzes/service-mesh/vpc-lattice/05-spiffe-to-iam-quiz.md)
   ...
   - [Ruta de datos del kernel](./service-mesh/vpc-lattice/07-kernel-datapath.md) | [Cuestionario](./quizzes/service-mesh/vpc-lattice/07-kernel-datapath-quiz.md)
...
1. [Descripción general de datos en EKS](./data-on-eks/README.md)
   ...
   - [Parte 4: Gobernanza de dominio, proyecto y membresía](./data-on-eks/sagemaker-unified-studio/01-domains-projects-governance.md) | [Cuestionario](./quizzes/data-on-eks/sagemaker-unified-studio/01-domains-projects-governance-quiz.md)
2. **Análisis profundo de Kafka en EKS**
...
3. **Análisis profundo de Spark en EKS**
...
4. **Análisis profundo de Airflow en EKS**
...
5. **Análisis profundo de Flink en EKS**
...
12. [Análisis profundo de LLM Gateway (Inference Gateway)](./ai-ml/08-llm-gateway.md) | [Cuestionario](./quizzes/ai-ml/08-llm-gateway-quiz.md)
...
2. **ArgoCD**
   ...
   - [Análisis profundo de experimentos de Rollouts](./gitops/argocd/10-rollouts-experiment.md) | [Cuestionario](./quizzes/gitops/argocd/10-rollouts-experiment-quiz.md)
...
### Gobernanza de nube empresarial
...
2. [Landing Zone, OU y control organizacional](./governance/01-landing-zone-and-ou.md) | [Cuestionario](./quizzes/governance/01-landing-zone-and-ou-quiz.md)
...
4. [Arquitectura EKS multicuenta y multiclúster](./governance/03-eks-multi-account-multi-cluster.md) | [Cuestionario](./quizzes/governance/03-eks-multi-account-multi-cluster-quiz.md)
...
0. [Descripción general de la ingeniería de plataforma](./platform-engineering/00-platform-engineering-overview.md) | [Cuestionario](./quizzes/platform-engineering/00-platform-engineering-overview-quiz.md)
...
5. [Prácticas recomendadas para el registro de contenedores](./container-registry/04-best-practices.md) | [Cuestionario](./quizzes/container-registry/04-best-practices-quiz.md)
...
3. **Logging**
   ...
   - [Recopiladores de logs](./observability/logging/05-collectors.md) | [Cuestionario](./quizzes/observability/logging/05-collectors-quiz.md)
4. **Trazado**
   - [Descripción general del trazado](./observability/tracing/README.md)
...
16. [Manual de solución de problemas](./ops/16-troubleshooting-playbook.md) | [Cuestionario](./quizzes/ops/16-troubleshooting-playbook-quiz.md)
...
Proporcionamos guías de laboratorio prácticas para trabajar en entornos reales después de aprender la teoría.

- [Lista de guías de laboratorio](./labs/README.md)
- Conceptos básicos: laboratorios de Linux básico, operaciones de Linux y contenedores
- Núcleo: laboratorios de Pod, Service, Storage y ConfigMap
...
7. [Parte 6: Análisis de trazado distribuido](./labs/observability/06-distributed-tracing-lab.md) | [Cuestionario](./quizzes/observability/labs/06-distributed-tracing-quiz.md)

## Guía de aprendizaje

### Ruta de aprendizaje para principiantes
1. Estudie en este orden: **Linux y contenedores** -> **Conceptos fundamentales de Kubernetes** -> **Amazon EKS**
2. Después de leer cada capítulo, realice el cuestionario correspondiente para comprobar su comprensión
3. Ejecute comandos y código de ejemplo de forma práctica en un entorno de práctica

### Ruta de aprendizaje para usuarios avanzados
1. Estudie en este orden: **Amazon EKS** -> **AI/ML** -> **Service Mesh** -> **Seguridad y políticas**
2. Profundice en las redes con la sección **Cilium**
3. Céntrese en herramientas o tecnologías específicas para un aprendizaje en profundidad

### Cómo usar los cuestionarios
- Haga clic en el enlace al cuestionario al final de cada documento para comprobar su aprendizaje
- Reflexione primero sobre las respuestas de estilo desplegable antes de revelarlas
- Revise el documento correspondiente para las preguntas que respondió incorrectamente

## Contribuciones

Si desea contribuir a este proyecto:
1. Envíe un issue cuando encuentre erratas o errores de contenido
2. Sugiera temas nuevos o mejoras
3. Sugiera adiciones o mejoras a las preguntas de los cuestionarios
