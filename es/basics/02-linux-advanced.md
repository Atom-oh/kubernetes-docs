...
Este documento cubre habilidades esenciales de operaciones en Linux para trabajar eficazmente en entornos de Kubernetes.
...
1. **Environment Variables**: Base para K8s ConfigMap/Secret
2. **Shell Scripting**: Esencial para init containers y health checks
3. **Text Processing**: Fundamental para analizar la salida de kubectl
4. **SSH**: Importante para depurar nodos
5. **Performance Monitoring**: Base del troubleshooting
