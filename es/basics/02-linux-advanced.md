...
> **Versiones compatibles**: Todas las distribuciones principales de Linux **Última actualización**: February 11, 2026

Este documento cubre las habilidades esenciales de operaciones en Linux para trabajar de forma eficaz en entornos Kubernetes.
...
1. **Variables de entorno**: base para ConfigMap/Secret de K8s
2. **Shell scripting**: esencial para init containers y health checks
3. **Procesamiento de texto**: central para analizar la salida de kubectl
4. **SSH**: importante para la depuración de nodos
5. **Monitoreo de rendimiento**: base del troubleshooting

***

[Anterior: Conceptos básicos de Linux](01-linux-basics.md) | [Siguiente: Conceptos básicos de contenedores](https://github.com/Atom-oh/kubernetes-docs/blob/main/en/basics/03-container-basics.md)
