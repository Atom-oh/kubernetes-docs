...
- C. Medir el rendimiento requerido, el costo total, la recuperación/checkpointing ante interrupciones y la liberación efectiva de recursos de Pods/nodos
- D. La noche reduce automáticamente las tarifas On-Demand

<details>
<summary>Mostrar respuesta</summary>

**Respuesta: C. Medir el rendimiento requerido, el costo total, la recuperación/checkpointing ante interrupciones y la liberación efectiva de recursos de Pods/nodos**
