...
Use 0 9 * * 1-5 con una duración de 8 h.0 9-17 * * 1-5 inicia cada hora y se extiende hasta01:00del día siguiente. Los presupuestos limitan la interrupción voluntaria, no la retirada de capacidad Spot por EC2, los fallos ni la expiración forzada.
</details>
