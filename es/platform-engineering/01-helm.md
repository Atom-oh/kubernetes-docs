...
No coloque secretos en valores predeterminados de charts, argumentos --set ni salida de depuración. --hide-secret cubre la salida de Kubernetes Secret durante dry-run, no la redacción general de todos los values/logs. Las referencias a Secret existentes entregadas mediante variables de entorno de la app siguen infringiendo las políticas de credenciales en archivos. Use volúmenes Secret aprobados y rutas de relectura/rotación de archivos.
