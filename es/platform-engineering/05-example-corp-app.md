...
![AWS LBC reconcilia TargetGroupBinding entre la infraestructura de ACK y la aplicación de kro](../.gitbook/assets/en-platform-engineering-05-example-corp-app-0.png)
...
Añada réplicas de Aurora mediante ACK DBInstances usando combinaciones de clase/región compatibles; los nombres/etiquetas no fijan de forma permanente los roles de writer. Siga la guía de promotionTier, endpoints y failover en el [ejemplo de RDS](ack/03-elbv2-route53-rds.md), y luego pruebe la carga y la recuperación reales.
